...
hoot diff test-output/cmd/PoiPolygonConflateStandaloneTest/output1.osm test-files/cmd/glacial/PoiPolygonConflateStandaloneTest/output1.osm || diff test-output/cmd/PoiPolygonConflateStandaloneTest/output1.osm test-files/cmd/glacial/PoiPolygonConflateStandaloneTest/output1.osm
