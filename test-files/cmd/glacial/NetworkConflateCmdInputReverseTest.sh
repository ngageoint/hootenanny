...
hoot map-diff test-output/cmd/NetworkConflateCmdInputReverseTest/output.osm test-files/cmd/glacial/NetworkConflateCmdInputReverseTest/output.osm || diff test-output/cmd/NetworkConflateCmdInputReverseTest/output.osm test-files/cmd/glacial/NetworkConflateCmdInputReverseTest/output.osm 
