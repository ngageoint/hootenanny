...
hoot conflate --warn -C core/Network.conf test-files/DcTigerRoads.osm test-files/DcGisRoads.osm test-output/cmd/NetworkConflateCmdInputReverseTest/output.osm
