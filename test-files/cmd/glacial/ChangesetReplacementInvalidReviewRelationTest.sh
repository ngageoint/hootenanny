...
# replacement derivation, do not crash the changeset generation. The actual stats themselves are of secondary importance, as the correctness of
# changeset generation is tested throroughly elsewhere.
