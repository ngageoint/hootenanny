...
hoot optimize-network-conf --error "test-files/cmd/glacial/OptimizeNetworkConflateSettingsCmdTest/static-tests" "case" "test-files/cmd/glacial/OptimizeNetworkConflateSettingsCmdTest/testSettings.json" 2 $OUTPUT_DIR/$OUTPUT_FILE "false" "test-files/cases/hoot-rnd/network/Config.conf"
