...
hoot conflate --warn -C core/Network.conf -D uuid.helper.repeatable=true -D writer.include.debug=true test-files/DcGisRoads.osm test-files/DcTigerRoads.osm test-output/cmd/NetworkConflateCmdTest/output.osm
...
hoot conflate --warn -C core/Network.conf -D uuid.helper.repeatable=true -D writer.include.debug=true test-files/Empty.osm test-files/Empty.osm tmp/dum.osm
