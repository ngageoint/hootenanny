...
hoot map-is-match test-output/cmd/NetworkConflateCmdTest/output.osm test-files/cmd/glacial/NetworkConflateCmdTest/output.osm || diff test-output/cmd/NetworkConflateCmdTest/output.osm test-files/cmd/glacial/NetworkConflateCmdTest/output.osm 
