...
hoot multiary-poi-conflate -C Testing.conf -D writer.include.debug.tags=true $TESTDIR/Input1.osm $TESTDIR/Input2.osm $TESTDIR/Input3.osm $HOOT_HOME/test-output/cmd/glacial/RndMultiaryPoiConflateCmdTest/Output.osm
