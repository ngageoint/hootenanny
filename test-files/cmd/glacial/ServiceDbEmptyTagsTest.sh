...
export HOOT_OPTS="-D hootapi.db.writer.create.user=true -D api.db.email=ApiDbTest@hoottestcpp.org -D hootapi.db.writer.overwrite.map=true -D writer.include.debug.tags=true -D poi.polygon.address.match.enabled=false --warn"
