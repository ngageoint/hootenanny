...
mkdir -p test-output/cmd/glacial/BadMatchPairTest

hoot conflate --warn -D match.creators="hoot::BuildingMatchCreator;hoot::ScriptMatchCreator,PoiGeneric.js;hoot::NetworkMatchCreator;hoot::ScriptMatchCreator,LinearWaterway.js;hoot::PoiPolygonMatchCreator;hoot::ScriptMatchCreator,Area.js" -D merger.creators="hoot::BuildingMergerCreator;hoot::ScriptMergerCreator;hoot::NetworkMergerCreator;hoot::PoiPolygonMergerCreator;hoot::ScriptMergerCreator" -D conflate.match.highway.classifier="hoot::HighwayExpertClassifier" -D way.subline.matcher="hoot::MaximalSublineMatcher" -D rubber.sheet.minimum.ties=4 -D rubber.sheet.ref=true -D uuid.helper.repeatable=true test-files/cmd/glacial/BadMatchPairTest/MapEditBandug-cropped-1.osm test-files/cmd/glacial/BadMatchPairTest/OSMmap-cropped-1.osm test-output/cmd/glacial/BadMatchPairTest/output.osm
