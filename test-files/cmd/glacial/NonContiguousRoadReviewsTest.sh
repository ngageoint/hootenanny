...
hoot conflate --warn -C ReferenceConflation.conf -C NetworkAlgorithm.conf \
 ...
 test-output/cmd/NonContiguousRoadReviewsTest/output.osm

hoot diff test-output/cmd/NonContiguousRoadReviewsTest/output.osm \
          test-files/cmd/glacial/NonContiguousRoadReviewsTest/output.osm || \
     diff test-output/cmd/NonContiguousRoadReviewsTest/output.osm \
          test-files/cmd/glacial/NonContiguousRoadReviewsTest/output.osm
