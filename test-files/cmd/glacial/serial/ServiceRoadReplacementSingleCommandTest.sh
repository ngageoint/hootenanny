...
IN_DIR=test-files/cmd/glacial/serial/ServiceRoadReplacementTest
...
hoot diff $GENERAL_OPTS $IN_DIR/ServiceRoadReplacementTest-replaced.osm $OUT_DIR/$TEST_NAME-replaced.osm
