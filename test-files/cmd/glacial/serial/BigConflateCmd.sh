...
hadoop fs -rmr ConflateDcTigerRoads.osm.pbf &> /dev/null || pass
hadoop fs -rmr ConflateDcGisRoads.osm.pbf &> /dev/null || pass
...
hadoop fs -mkdir ConflateDcTigerRoads.osm.pbf ConflateDcGisRoads.osm.pbf
hadoop fs -put $TEST_FILES/DcTigerRoads.pbf ConflateDcTigerRoads.osm.pbf/
hadoop fs -put $TEST_FILES/DcGisRoads.pbf ConflateDcGisRoads.osm.pbf/

echo "Run our conflation"
hoot --big-conflate ConflateDcTigerRoads.osm.pbf ConflateDcGisRoads.osm.pbf DcConflated.osm.pbf
