...
echo ""
hoot changeset-derive $GENERAL_OPTS $CHANGESET_DERIVE_OPTS $OUT_DIR/$TEST_NAME-ref-cropped.osm $OUT_DIR/$TEST_NAME-conflated.osm $OUT_DIR/$TEST_NAME-changeset-2.osc.sql $REF_LAYER
