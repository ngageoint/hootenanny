...
GENERAL_OPTS="--debug -D log.class.filter=ChangesetReplacementCreator;MapCropper;OsmMap;OsmMapWriterFactory -D uuid.helper.repeatable=true -D writer.include.debug.tags=true -D debug.maps.write=true -D debug.maps.filename=$OUT_DIR/debug.osm"
