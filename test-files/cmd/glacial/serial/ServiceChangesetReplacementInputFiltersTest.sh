...
# replace only schools or non-school POIs with "School" in the name in the reference dataset with only schools or non-school POIs with "School" 
# in the name from the secondary dataset (OR the two criterion together)
