...
GENERAL_OPTS="--trace -D log.class.filter=UnconnectedWaySnapper;IndexElementsVisitor;OsmUtils;ChangesetReplacementCreator;CopyMapSubsetOp -D uuid.helper.repeatable=true -D writer.include.debug.tags=true -D reader.add.source.datetime=false -D writer.include.circular.error.tags=false -D debug.maps.write=true -D debug.maps.filename=$OUT_DIR/debug.osm"
