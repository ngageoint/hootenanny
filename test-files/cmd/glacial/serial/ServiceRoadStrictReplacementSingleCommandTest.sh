...
GENERAL_OPTS="--trace -D log.class.filter=UnconnectedWaySnapper -D uuid.helper.repeatable=true -D writer.include.debug.tags=true -D debug.maps.write=true -D debug.maps.filename=$OUT_DIR/debug.osm"
