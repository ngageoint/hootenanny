...
GENERAL_OPTS="--trace -D log.class.filter=RemoveRelationByEid;RemoveInvalidMultilineStringMembersVisitor -D uuid.helper.repeatable=true -D writer.include.debug.tags=true -D debug.maps.write=true -D debug.maps.filename=$OUT_DIR/debug.osm"
