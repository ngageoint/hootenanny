...
hoot map-diff test-output/cmd/PowerLineConflateTest/output.osm test-files/cmd/glacial/PowerLineConflateTest/output.osm || diff test-output/cmd/PowerLineConflateTest/output.osm test-files/cmd/glacial/PowerLineConflateTest/output.osm
