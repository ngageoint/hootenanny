...
Value in degrees by which the specified AOI (convert.bounds) will be expanded when calculating
...
----
hoot convert -D convert.bounds=106.851,-6.160,107.052,-5.913 input output
----
