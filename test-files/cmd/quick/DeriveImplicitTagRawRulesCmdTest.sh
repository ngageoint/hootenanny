...
hoot implicit-tagging-derive-raw-rules --warn poi "$INPUT_DIR/yemen-crop-2.osm.pbf;$INPUT_DIR/philippines-1.osm.pbf" "translations/OSM_Ingest.js;translations/OSM_Ingest.js" $OUTPUT_DIR/DeriveRawImplicitTagRulesCmdTest-out.implicitTagRules
