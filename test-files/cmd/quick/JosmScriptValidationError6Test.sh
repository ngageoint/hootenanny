...
# Should fail b/c TO_VALIDATE_1 and TO_VALIDATE_2 reference the same file.
...
VALIDATION_REPORT_GOLD_2=test-files/cmd/slow/ConflateCmdTest/output2-validation-report
