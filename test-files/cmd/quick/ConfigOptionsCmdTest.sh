...
echo ""
hoot config-options -D config.options.file=$CONFIG_FILE --option-names
echo ""

echo "Listing all option names and descriptions..."
echo ""
hoot config-options -D config.options.file=$CONFIG_FILE --option-details
echo ""

echo "Listing all option names containing 'poi.polygon'..."
echo ""
hoot config-options -D config.options.file=$CONFIG_FILE poi.polygon --option-names
echo ""

echo "Listing all option names containing 'poi.polygon' and their descriptions..."
echo ""
hoot config-options -D config.options.file=$CONFIG_FILE poi.polygon --option-details
