...
hoot derive-changeset test-files/cmd/quick/DeriveChangesetCmdTest/map1.osm test-files/cmd/quick/DeriveChangesetCmdTest/map2.osm test-output/cmd/DeriveChangesetCmdTest/changeset-1.osc
diff test-output/cmd/DeriveChangesetCmdTest/changeset-1.osc test-files/cmd/quick/DeriveChangesetCmdTest/changeset-1.osc

hoot derive-changeset test-files/cmd/quick/DeriveChangesetCmdTest/map1.osm "" test-output/cmd/DeriveChangesetCmdTest/changeset-2.osc
