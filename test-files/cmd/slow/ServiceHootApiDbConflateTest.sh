...
hoot map-is-match test-files/cmd/slow/ServiceHootApiDbConflateTest/output1.osm test-output/cmd/ServiceHootApiDbConflateTest/output1.osm
...
hoot map-is-match test-files/cmd/slow/ServiceHootApiDbConflateTest/output2.osm test-output/cmd/ServiceHootApiDbConflateTest/output2.osm
