...
hoot optimize-conflate-settings --error "test-files/cmd/slow/OptimizeConflateSettingsCmd/static-tests" "case" "test-files/cmd/slow/OptimizeConflateSettingsCmd/testSettings.json" 2 $OUTPUT_DIR/$OUTPUT_FILE "false" "test-files/cases/hoot-rnd/network/Config.conf"
