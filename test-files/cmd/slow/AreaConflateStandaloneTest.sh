...
hoot map-is-match test-output/cmd/AreaConflateStandaloneTest/output1.osm test-files/cmd/slow/AreaConflateStandaloneTest/output1.osm || diff test-output/cmd/AreaConflateStandaloneTest/output1.osm test-files/cmd/slow/AreaConflateStandaloneTest/output1.osm
