...
VALIDATORS_CONFIG_DIR=test-files/cmd/slow/JosmValidateCmdTest
...
hoot clean $LOG_LEVEL $CONFIG -D map.cleaner.transforms="hoot::JosmMapCleaner" -D josm.validators.file=$VALIDATORS_CONFIG_DIR/validators $inputfile $outputfile1
hoot diff $LOG_LEVEL $CONFIG $comparefile $outputfile1 || diff $comparefile $outputfile1

outputfile2=$OUTPUT_DIR/out2.osm
hoot convert $LOG_LEVEL $CONFIG -D convert.ops="hoot::JosmMapCleaner" -D josm.validators.file=$VALIDATORS_CONFIG_DIR/validators $inputfile $outputfile2
