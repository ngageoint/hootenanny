...
hoot convert --warn -D api.db.email=test@test.com -D changeset.user.id=1 test-files/DcGisRoads.osm $OSM_API_DB_URL
...
hoot calculate-tiles --warn -D api.db.email=test@test.com -D id.generator="hoot::PositiveIdGenerator" -D convert.bounding.box="-77.04856,38.8855,-77.0292,38.899" $OSM_API_DB_URL";"$HOOT_DB_URL"/DcTigerRoads" $OUTPUT_DIR/output-cropped.geojson
