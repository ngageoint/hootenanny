...
hoot convert --warn -D api.db.email=test@test.com -D changeset.user.id=1 -D osmapidb.bulk.writer.validate.data=true test-files/DcGisRoads.osm $OSM_API_DB_URL
