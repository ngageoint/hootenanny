...
hoot derive-changeset -D changeset.sql.use.internal.ids=true test-files/cmd/slow/DeriveChangesetCmdTest/map1.osm test-files/cmd/slow/DeriveChangesetCmdTest/map2.osm test-output/cmd/ServiceDeriveChangesetCmdTest/changeset.osc.sql "$DB_URL"
