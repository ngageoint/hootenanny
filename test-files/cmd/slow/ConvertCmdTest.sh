...
hoot map-is-match test-output/cmd/ConvertCmdTest/ToyTestAShp.osm test-files/cmd/slow/ConvertCmdTest/ToyTestAShp.osm
...
hoot map-is-match test-files/ToyTestA.osm test-output/cmd/ConvertCmdTest/ToyTestA2.osm
...
hoot map-is-match test-files/cmd/slow/ConvertCmdTest/AllDataTypesAPois.osm test-output/cmd/ConvertCmdTest/AllDataTypesA.osm
