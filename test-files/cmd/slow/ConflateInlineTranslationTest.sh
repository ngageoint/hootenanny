...
CONFIG="-C AttributeConflation.conf -C UnifyingAlgorithm.conf -C Testing.conf -D conflate.use.data.source.ids.1=false -D conflate.use.data.source.ids.2=true -D match.creators=HighwayMatchCreator -D merger.creators=HighwayMergerCreator"
LOG_LEVEL="--warn"
