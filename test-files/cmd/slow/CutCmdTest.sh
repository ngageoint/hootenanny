...
hoot cut $CONFIG test-files/cmd/slow/GenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/slow/CutCmdTest/output-1.osm
...
hoot cut $CONFIG test-files/cmd/slow/GenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/slow/CutCmdTest/output-2.osm --crop
