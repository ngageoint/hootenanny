...
TO_VALIDATE_1=test-output/cmd/slow/RailwayConflateTest/output.osm
VALIDATION_REPORT_GOLD_1=test-files/cmd/slow/RailwayConflateTest/output-validation-report
