...
# Normal Hoot options
HOOT_OPT="-D hash.seed.zero=true --warn"
...
hoot convert --debug -D hash.seed.zero=true $outputDir/new_GGDMv30.osm $outputDir".shp" --trans $TRANS # > tmp/GGDM30_to_GGDM.txt
