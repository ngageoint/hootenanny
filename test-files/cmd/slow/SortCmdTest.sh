...
hoot diff --warn test-output/cmd/slow/SortCmdTest/output.geonames test-files/cmd/slow/SortCmdTest/output.geonames || diff test-output/cmd/slow/SortCmdTest/output.geonames test-files/cmd/slow/SortCmdTest/output.geonames

hoot sort --warn test-files/cmd/slow/SortCmdTest/input.osm test-output/cmd/slow/SortCmdTest/output.osm
hoot diff --warn test-output/cmd/slow/SortCmdTest/output.osm test-files/cmd/slow/SortCmdTest/output.osm || diff test-output/cmd/slow/SortCmdTest/output.osm test-files/cmd/slow/SortCmdTest/output.osm
