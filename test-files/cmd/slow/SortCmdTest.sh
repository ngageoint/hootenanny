...
hoot is-match --warn test-output/cmd/slow/SortCmdTest/output.osm.pbf test-files/cmd/slow/SortCmdTest/output.osm.pbf || diff test-output/cmd/slow/SortCmdTest/output.osm.pbf test-files/cmd/slow/SortCmdTest/output.osm.pbf
