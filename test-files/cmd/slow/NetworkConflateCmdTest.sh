...
hoot conflate --warn -C Network.conf test-files/DcGisRoads.osm test-files/DcTigerRoads.osm test-output/cmd/NetworkConflateCmdTest/output.osm
...
hoot conflate --warn -C Network.conf test-files/Empty.osm test-files/Empty.osm tmp/dum.osm
