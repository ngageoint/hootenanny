...
hoot cookie-cut test-files/cmd/glacial/RndGenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/CookieCutCmdTest/output-1.osm
...
hoot cookie-cut test-files/cmd/glacial/RndGenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/CookieCutCmdTest/output-2.osm --crop
