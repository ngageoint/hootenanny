...
hoot cookie-cut -D writer.include.circular.error.tags=true test-files/cmd/glacial/RndGenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/CookieCutCmdTest/output-1.osm
...
hoot cookie-cut -D writer.include.circular.error.tags=true test-files/cmd/glacial/RndGenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/CookieCutCmdTest/output-2.osm --crop
