...
hoot cookie-cut $CONFIG test-files/cmd/slow/GenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/slow/CookieCutCmdTest/output-1.osm
...
hoot cookie-cut $CONFIG test-files/cmd/slow/GenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/slow/CookieCutCmdTest/output-2.osm --crop
