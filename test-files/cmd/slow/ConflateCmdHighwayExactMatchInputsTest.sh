...
hoot conflate $CONFIG -D match.creators="HighwayMatchCreator" -D merger.creators="HighwayMergerCreator" -D "writer.include.debug.tags=true" -D "writer.include.conflate.score.tags=true" -D "uuid.helper.repeatable=true" test-files/DcTigerRoads.osm test-files/DcTigerRoadsHighwayExactMatchInputs.osm test-output/cmd/slow/ConflateCmdHighwayExactMatchInputsTest/output.osm
