...
OUTPUT_DIR=test-output/cmd/slow/RndServiceCalculateTilesCmdTest
...
hoot convert --warn -D api.db.email=test@test.com -D changeset.user.id=1 -D apidb.bulk.inserter.validate.data=true test-files/DcGisRoads.osm $OSM_API_DB_URL
...
hoot tiles-calculate --warn -D api.db.email=test@test.com -D convert.bounding.box="-77.04856,38.8855,-77.0292,38.899" $OSM_API_DB_URL";"$HOOT_DB_URL"/DcTigerRoads" $OUTPUT_DIR/output-cropped.geojson 1000 0.001
