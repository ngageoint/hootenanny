...
hoot map-diff test-files/cmd/slow/ServiceOsmApiDbReaderTest/output1.osm $OUTPUT_DIR/output1.osm
...
hoot map-diff test-files/cmd/slow/ServiceOsmApiDbReaderTest/output2.osm $OUTPUT_DIR/output2.osm
