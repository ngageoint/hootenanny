...
hoot map-is-match $HOOT_OPTS "$HOOT_DB_URL/ToyTestA" $OSM_API_DB_URL
...
hoot map-is-match $HOOT_OPTS $OSM_API_DB_URL "$HOOT_DB_URL/ToyTestA"

echo "streaming hoot api db --> pbf..."
echo ""
hoot convert $HOOT_OPTS test-files/ToyTestA.osm "$HOOT_DB_URL/ToyTestA"
hoot convert $HOOT_OPTS "$HOOT_DB_URL/ToyTestA" $OUTPUT_DIR/ToyTestA-hootapidb.osm.pbf
hoot map-is-match $HOOT_OPTS "$HOOT_DB_URL/ToyTestA" $OUTPUT_DIR/ToyTestA-hootapidb.osm.pbf
...
hoot map-is-match $HOOT_OPTS $OSM_API_DB_URL $OUTPUT_DIR/ToyTestA-osmapidb.osm.pbf
...
hoot map-is-match $HOOT_OPTS "$HOOT_DB_URL/ToyTestA" $OUTPUT_DIR/ToyTestA-hootapidb.osm
...
hoot map-is-match $HOOT_OPTS $OSM_API_DB_URL $OUTPUT_DIR/ToyTestA-osmapidb.osm
...
hoot map-is-match $HOOT_OPTS $GOLD_DIR/Poi1-cropped.osm $OUTPUT_DIR/Poi1-cropped-hootapidb.osm
...
hoot map-is-match $HOOT_OPTS $GOLD_DIR/Poi1-cropped.osm $OUTPUT_DIR/Poi1-cropped-osmapidb.osm
...
hoot map-is-match $HOOT_OPTS $GOLD_DIR/Poi1-cropped-2.osm $OUTPUT_DIR/Poi1-cropped-hootapidb-ogr.osm
...
hoot map-is-match $HOOT_OPTS $GOLD_DIR/Poi1-cropped-2.osm $OUTPUT_DIR/Poi1-cropped-osmapidb-ogr.osm
