...
/* create node 1669791*/
INSERT INTO nodes (node_id, latitude, longitude, changeset_id, visible, "timestamp", tile, version) VALUES (1669791, 388549524, 1048987389, 3, true, (now() at time zone 'utc'), 3852309038, 1);
INSERT INTO current_nodes (id, latitude, longitude, changeset_id, visible, "timestamp", tile, version) VALUES (1669791, 388549524, 1048987389, 3, true, (now() at time zone 'utc'), 3852309038, 1);
/* create node 1669793*/
INSERT INTO nodes (node_id, latitude, longitude, changeset_id, visible, "timestamp", tile, version) VALUES (1669793, 388549321, 1048979050, 3, true, (now() at time zone 'utc'), 3852309038, 1);
INSERT INTO current_nodes (id, latitude, longitude, changeset_id, visible, "timestamp", tile, version) VALUES (1669793, 388549321, 1048979050, 3, true, (now() at time zone 'utc'), 3852309038, 1);
/* create way 1669801*/
INSERT INTO ways (way_id, changeset_id, visible, "timestamp", version) VALUES (1669801, 3, true, (now() at time zone 'utc'), 1);
INSERT INTO current_ways (id, changeset_id, visible, "timestamp", version) VALUES (1669801, 3, true, (now() at time zone 'utc'), 1);
