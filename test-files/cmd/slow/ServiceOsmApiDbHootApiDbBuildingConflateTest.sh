...
scripts/core/ServiceOsmApiDbHootApiDbConflate.sh test-files/cmd/slow/ServiceOsmApiDbHootApiDbBuildingConflateTest/BostonSubsetRoadBuilding_FromShp-cropped-4.osm test-files/cmd/slow/ServiceOsmApiDbHootApiDbBuildingConflateTest/BostonSubsetRoadBuilding_FromOsm-cropped-4.osm -71.4771,42.4835,-71.4758,42.4841 "unifying" ServiceOsmApiDbHootApiDbBuildingConflateTest false -1
