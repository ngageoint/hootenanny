...
hoot conflate -D hash.seed.zero=true -D writer.include.debug.tags=true -D match.creators="hoot::BuildingMatchCreator" -D merger.creators="hoot::BuildingMergerCreator" test-files/ToyBuildingsTestA.osm test-files/ToyBuildingsTestB.osm $STATS_OUT.osm --stats > $STATS_OUT
