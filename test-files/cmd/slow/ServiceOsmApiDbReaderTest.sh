...
export HOOT_OPTS="-D reader.add.source.datetime=false -D uuid.helper.repeatable=true -D reader.preserve.all.tags=true -D writer.include.circular.error=false -D changeset.user.id=1"
