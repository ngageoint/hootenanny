...
hoot cookie-cut test-files/cmd/slow/GenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/CookieCutterCmdTest/output-1.osm
...
hoot cookie-cut test-files/cmd/slow/GenerateAlphaShapeCmdTest/output-1.osm test-files/DcTigerRoads.osm test-output/cmd/CookieCutterCmdTest/output-2.osm --crop
