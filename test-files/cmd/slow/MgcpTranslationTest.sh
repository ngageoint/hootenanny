...
hoot convert-ogr2osm translations/MgcpTest.js test-output/translation/MgcpTranslated.osm test-output/translation/MgcpTestLines.shp
...
function checkMgcpV3 {
    ...
    hoot convert-ogr2osm translations/MgcpTest.js $OUT $IN
    #echo $IN  $OUT
    ...
    rm -rf $OUT4
    hoot convert-osm2ogr translations/MGCP_TRD4.js $OUT $OUT4.shp
}
