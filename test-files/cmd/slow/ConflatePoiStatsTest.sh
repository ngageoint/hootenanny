...
hoot conflate -C Testing.conf -D writer.include.debug.tags=true -D "match.creators=ScriptMatchCreator,Poi.js" -D "merger.creators=ScriptMergerCreator" test-files/dcpoi_clip.osm test-files/mapcruzinpoi_clip.osm $STATS_OUT.osm --stats > $STATS_OUT
