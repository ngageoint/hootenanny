...
# that doesn't change
scripts/core/ServiceOsmApiDbHootApiDbConflate.sh test-files/cmd/slow/ServiceOsmApiDbHootApiDbPoiPolygonConflateTest/PoiPolygon1.osm test-files/cmd/slow/ServiceOsmApiDbHootApiDbPoiPolygonConflateTest/PoiPolygon2.osm -122.4230,37.7620,-122.4204,37.7647 "unifying" ServiceOsmApiDbHootApiDbPoiPolygonConflateTest
