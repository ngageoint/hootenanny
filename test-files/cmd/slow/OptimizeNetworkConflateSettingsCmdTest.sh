...
hoot optimize-network-conf --error -C Testing.conf "test-files/cmd/slow/OptimizeNetworkConflateSettingsCmdTest/static-tests" "case" "test-files/cmd/slow/OptimizeNetworkConflateSettingsCmdTest/testSettings.json" 2 $OUTPUT_DIR/$OUTPUT_FILE "false" "test-files/cases/hoot-rnd/network/Config.conf"
