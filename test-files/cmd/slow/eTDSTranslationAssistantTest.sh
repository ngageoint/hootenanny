...
do
    ...
    hoot convert-ogr2osm $TA_IN/cali-translation-$schema.js $TA_OUT/$TA_FILE-$schema.osm $TA_IN/$TA_FILE.shp
...
hoot convert-ogr2osm $TA_IN/cali-translation-tdsv61-fcode.js $TA_OUT/$TA_FILE-tdsv61-fcode.osm $TA_IN/$TA_FILE.shp
