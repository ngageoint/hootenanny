...
psql -a -e -E -L=/home/vagrant/hoot/test-files/cmd/slow/1263-test -o=/home/vagrant/hoot/test-files/cmd/slow/1263-test2 -h $DB_HOST -p $DB_PORT -d $DB_NAME -U $DB_USER -c "INSERT INTO job_status (job_id, start, status) VALUES ('$JOB_ID', now(), 2)"
