...
hoot conflate -D writer.include.debug=true test-files/BostonSubsetRoadBuilding_FromShp.osm test-files/BostonSubsetRoadBuilding_FromOsm.osm $STATS_OUT.osm > $STATS_OUT
