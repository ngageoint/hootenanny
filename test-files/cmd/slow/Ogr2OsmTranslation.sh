...
hoot convert-ogr2osm translations/Identity.js $OUT/OnePointTranslated.osm $OUT/OnePointPoints.shp
...
cd $HOOT_HOME
hoot convert-ogr2osm translations/Identity.js test-output/AllDataTypesA.osm /vsizip/./test-output/AllDataTypesA.zip
hoot stats test-output/AllDataTypesA.osm | grep -w 'Node Count\|Way Count\|Relation Count'

hoot convert-ogr2osm -D ogr.reader.bounding.box=-104.931,38.823,-104.869,38.877 translations/Identity.js test-output/AllDataTypesABBox.osm /vsizip/./test-output/AllDataTypesA.zip
