...
hoot convert $HOOT_OPTS -D merge.nearby.nodes.distance=1.0 -D schema.translation.script=$HOOT_HOME/translations/$TRANSLATION -D convert.ops+=$ADDITIONAL_VISITORS $INPUTS $TEST_OUTPUT
