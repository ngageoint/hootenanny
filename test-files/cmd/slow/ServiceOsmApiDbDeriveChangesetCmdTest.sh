...
hoot derive-changeset -D changeset.user.id=1 test-files/cmd/slow/DeriveChangesetCmdTest/map1.osm test-files/cmd/slow/DeriveChangesetCmdTest/map2.osm test-output/cmd/ServiceOsmApiDbDeriveChangesetCmdTest/changeset.osc.sql "$DB_URL"
