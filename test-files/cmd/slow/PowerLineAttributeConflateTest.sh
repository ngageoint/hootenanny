...
hoot conflate $CONFIG -C UnifyingAlgorithm.conf -C AttributeConflation.conf -D uuid.helper.repeatable=true -D match.creators="hoot::ScriptMatchCreator,PowerLine.js" -D merger.creators="hoot::ScriptMergerCreator" test-files/cmd/slow/PowerLineConflateTest/power-line-1.osm test-files/cmd/slow/PowerLineConflateTest/power-line-2.osm $OUT_DIR/output.osm
