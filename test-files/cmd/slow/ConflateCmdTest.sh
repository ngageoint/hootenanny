...
hoot conflate -C Testing.conf test-files/conflate/unified/AllDataTypesA.osm test-files/conflate/unified/AllDataTypesB.osm test-output/cmd/ConflateCmdTest/output.osm
...
hoot conflate -C Testing.conf --warn test-files/Empty.osm test-files/Empty.osm tmp/dum.osm
