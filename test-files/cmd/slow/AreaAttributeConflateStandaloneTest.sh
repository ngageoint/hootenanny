...
TO_VALIDATE_1=test-output/cmd/slow/AreaAttributeConflateStandaloneTest/output.osm
VALIDATION_REPORT_GOLD_1=test-files/cmd/slow/AreaAttributeConflateStandaloneTest/output-validation-report
