...
/* modify way 1*/
INSERT INTO ways (way_id, changeset_id, visible, "timestamp", version) VALUES (1, 1, true, (now() at time zone 'utc'), 2);
UPDATE current_ways SET changeset_id=1, visible=true, "timestamp"=(now() at time zone 'utc'), version=2 WHERE id=1;
...
INSERT INTO way_tags (way_id, k, v, version) VALUES (1, 'key1', 'value1', 2);
...
/* modify node 3*/
INSERT INTO nodes (node_id, latitude, longitude, changeset_id, visible, "timestamp", tile, version) VALUES (3, -88, 69, 1, true, (now() at time zone 'utc'), 2505397589, 2);
UPDATE current_nodes SET latitude=-88, longitude=69, changeset_id=1, visible=true, "timestamp"=(now() at time zone 'utc'), tile=2505397589, version=2 WHERE id=3;
DELETE FROM current_node_tags WHERE node_id = 3;
DELETE FROM node_tags WHERE node_id = 3;
/* delete way 2*/
INSERT INTO ways (way_id, changeset_id, visible, "timestamp", version) VALUES (2, 1, false, (now() at time zone 'utc'), 2);
...
/* create node 11*/
INSERT INTO nodes (node_id, latitude, longitude, changeset_id, visible, "timestamp", tile, version) VALUES (11, 57, -30, 2, true, (now() at time zone 'utc'), 1789569706, 1);
INSERT INTO current_nodes (id, latitude, longitude, changeset_id, visible, "timestamp", tile, version) VALUES (11, 57, -30, 2, true, (now() at time zone 'utc'), 1789569706, 1);
/* modify way 5*/
INSERT INTO ways (way_id, changeset_id, visible, "timestamp", version) VALUES (5, 2, true, (now() at time zone 'utc'), 2);
UPDATE current_ways SET changeset_id=2, visible=true, "timestamp"=(now() at time zone 'utc'), version=2 WHERE id=5;
...
INSERT INTO way_tags (way_id, k, v, version) VALUES (5, 'key1', 'value1', 2);
...
/* create relation 2*/
INSERT INTO relations (relation_id, changeset_id, visible, "timestamp", version) VALUES (2, 2, true, (now() at time zone 'utc'), 1);
INSERT INTO current_relations (id, changeset_id, visible, "timestamp", version) VALUES (2, 2, true, (now() at time zone 'utc'), 1);
...
/* delete node 16*/
INSERT INTO nodes (node_id, latitude, longitude, changeset_id, visible, "timestamp", tile, version) VALUES (16, -43, -6, 2, false, (now() at time zone 'utc'), 1073741823, 2);
...
UPDATE current_nodes SET changeset_id=2, visible=false, version=2 WHERE id=16;
