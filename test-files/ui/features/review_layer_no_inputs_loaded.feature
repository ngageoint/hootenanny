Feature: Review Conflated Layer with Active Reviews After Deleting Inputs
    ...
    Scenario: Import Input Datasets
        ...
        Then I fill row 0 input "Save As" with value "1UndividedHwy_Cucumber"
        ...
        Then I fill row 1 input "Save As" with value "2UndividedHwy_Cucumber"
        ...
        Then I wait 2 "minutes" to see "1UndividedHwy_Cucumber"
        And I wait 2 "minutes" to see "2UndividedHwy_Cucumber"
        And I select the "sprocket" div

    Scenario: Conflate The Two Datasets
        When I press "Add Reference Dataset"
        And I click the "1UndividedHwy_Cucumber" Dataset
        And I press "Add Layer"
        Then I wait 15 "seconds" to see "span.strong" element with text "1UndividedHwy_Cucumber"
        And I press "Add Secondary Dataset"
        And I click the "2UndividedHwy_Cucumber" Dataset
        And I press "Add Layer"
        Then I wait 15 "seconds" to see "span.strong" element with text "2UndividedHwy_Cucumber"
        Then I should see "Conflate"
        And I press "Conflate"
        And I fill "saveAs" input with "3MergeHwy_Cucumber"
        And I scroll element into view and press "conflate2"
        Then I wait 30 "seconds" to see "Conflating …"
        Then I wait 3 "minutes" to see "3MergeHwy_Cucumber"
    ...
    Scenario: Delete Input Datasets
        ...
        Then I click the "1UndividedHwy_Cucumber" Dataset and the "2UndividedHwy_Cucumber" Dataset
        And I context click the "2UndividedHwy_Cucumber" Dataset
        And I click the "Delete" context menu item
        And I wait
        And I accept the alert
        Then I should not see "1UndividedHwy_Cucumber" dataset after 30 "seconds"
        Then I should not see "2UndividedHwy_Cucumber" dataset after 30 "seconds"

    Scenario: Add conflated dataset with Reviews
        When I select the "sprocket" div
        And I press "Add Reference Dataset"
        And I click the "3MergeHwy_Cucumber" Dataset
        And I press "Add Layer"
        And I wait
        And I accept the alert
        Then I wait 15 "seconds" to see "span.strong" element with text "3MergeHwy_Cucumber"
        ...
        And I select the "sprocket" div
        And I click the "3MergeHwy_Cucumber" Dataset
        And I context click the "3MergeHwy_Cucumber" Dataset
        And I click the "Delete" context menu item
        And I accept the alert
        Then I should not see "3MergeHwy_Cucumber" dataset after 30 "seconds"