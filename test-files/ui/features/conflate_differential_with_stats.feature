Feature: Conflate differential with stats
  ...
  Scenario: I can conflate data with Differential Conflation and see statistics
    ...
    And I click the "DiffConflateInput1" Dataset
    And I press "Add Layer"
    Then I wait 30 "seconds" to see "span.strong" element with text "DiffConflateInput1"
    And I press "Add Secondary Dataset"
    And I click the "DiffConflateInput2" Dataset
    And I press "Add Layer"
    Then I wait 30 "seconds" to see "span.strong" element with text "DiffConflateInput2"
    Then I should see "Conflate"
    And I press "Conflate"
    And I fill "saveAs" input with "DiffConflateMerged"
    ...
    Then I wait 3 "minutes" to see "DiffConflateMerged"
    ...
    Then the download file "DiffConflateMerged-stats.tsv" should exist
    Then I click the "trash" button
    And I accept the alert
    And I wait 5 "seconds" to not see "DiffConflateMerged"
