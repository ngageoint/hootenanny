...
geonames.rules = {
    ...
    one2one : {
        'ADM1H':{'poi:type':'historical_first-order_administrative_division'}, //  historical first-order administrative division: a former first-order administrative division
        'ADM1':{'poi:type':'first-order_administrative_division'}, //  first-order administrative division: a primary administrative division of a country, such as a state in the United States
        'ADM2H':{'poi:type':'historical_second-order_administrative_division'}, //  historical second-order administrative division: a former second-order administrative division
        'ADM2':{'poi:type':'second-order_administrative_division'}, //  second-order administrative division: a subdivision of a first-order administrative division
        'ADM3H':{'poi:type':'historical_third-order_administrative_division'}, //  historical third-order administrative division: a former third-order administrative division
        'ADM3':{'poi:type':'third-order_administrative_division'}, //  third-order administrative division: a subdivision of a second-order administrative division
        'ADM4H':{'poi:type':'historical_fourth-order_administrative_division'}, //  historical fourth-order administrative division: a former fourth-order administrative division
        'ADM4':{'poi:type':'fourth-order_administrative_division'}, //  fourth-order administrative division: a subdivision of a third-order administrative division
        'ADM5':{'poi:type':'fifth-order_administrative_division'}, //  fifth-order administrative division: a subdivision of a fourth-order administrative division
        'ADMDH':{'poi:type':'historical_administrative_division_'}, //  historical administrative division : a former administrative division of a political entity, undifferentiated as to administrative level
        ...
        'ADMD':{'poi:type':'administrative_division'}, //  administrative division: an administrative division of a country, undifferentiated as to administrative level
        'ADMF':{'building':'yes','office':'administrative'}, //  administrative facility: a government building
        'ADMF':{'poi:type':'administrative_facility'}, //  administrative facility: a government building
        'AGRC':{'place':'farm'}, //  agricultural colony: a tract of land set aside for agricultural settlement
        ...
        'APNU':{'poi:type':'apron'}, //  apron: a gentle slope, with a generally smooth surface, particularly found around groups of islands and seamounts
        ...
        'ARCH':{'poi:type':'arch'}, //  arch: a natural or man-made structure in the form of an arch
        'ARCU':{'poi:type':'arch'}, //  arch: a low bulge around the southeastern end of the island of Hawaii
        'AREA':{'poi:type':'area'}, //  area: a tract of land without homogeneous character or boundaries
        'ARRU':{'poi:type':'arrugado'}, //  arrugado: an area of subdued corrugations off Baja California
        'ASPH':{'poi:type':'asphalt_lake'}, //  asphalt lake: a small basin containing naturally occurring asphalt
        ...
        'BAR':{'poi:type':'bar_shallow_water'}, //  bar: a shallow ridge or mound of coarse unconsolidated material in a stream channel, at the mouth of a stream, estuary, or lagoon and in the wave-break zone along coasts
        ...
        'BDLU':{'geological':'borderland'}, //  borderland: a region adjacent to a continent, normally occupied by or bordering a shelf, that is highly irregular with depths well in excess of those typical of a shelf
        'BGHT':{'natural':'bight'}, //  bight(s): an open body of water forming a slight recession in a coastline
        'BKSU':{'poi:type':'banks'}, //  banks: elevations, typically located on a shelf, over which the depth of water is relatively shallow but sufficient for safe surface navigation
        ...
        'BNK':{'poi:type':'bank_shallow_water'}, //  bank(s): an elevation, typically located on a shelf, over which the depth of water is relatively shallow but sufficient for most surface navigation
        'BNKR':{'poi:type':'stream_bank'}, //  stream bank: a sloping margin of a stream channel which normally confines the stream to its channel on land
        'BNKU':{'geological':'bank'}, //  bank: an elevation, typically located on a shelf, over which the depth of water is relatively shallow but sufficient for safe surface navigation
        ...
        'BP':{'poi:type':'boundary_marker'}, //  boundary marker: a fixture marking a point along a boundary
        ...
        'BSNU':{'landuse':'basin'}, //  basin: a depression more or less equidimensional in plan and of variable extent
        'BSTN':{'building':'farm_auxiliary', 'poi:type':'baling_station'}, //  baling station: a facility for baling agricultural products
        ...
        'CDAU':{'poi:type':'cordillera'}, //  cordillera: an entire mountain system including the subordinate ranges, interior plateaus, and basins
        'CFT':{'natural':'cleft'}, //  cleft(s): a deep narrow slot, notch, or groove in a coastal cliff
        'CHNL':{'poi:type':'lake_channel(s)'}, //  lake channel(s): that part of a lake having water deep enough for navigation between islands, shoals, etc.
        'CHNM':{'poi:type':'marine_channel'}, //  marine channel: that part of a body of water deep enough for navigation through an area otherwise not suitable
        'CHNN':{'poi:type':'navigation_channel'}, //  navigation channel: a buoyed channel of sufficient depth for the safe navigation of vessels
        'CHN':{'poi:type':'channel'}, //  channel: the deepest part of a stream, bay, lagoon, or strait, through which the main current flows
        ...
        'CLG':{'poi:type':'clearing'}, //  clearing: an area in a forest with trees removed
        ...
        'CNFL':{'poi:type':'confluence'}, //  confluence: a place where two or more streams or intermittent streams flow together
        'CNLA':{'bridge':'aqueduct'}, //  aqueduct: a conduit used to carry water
        'CNLB':{'poi:type':'canal_bend'}, //  canal bend: a conspicuously curved or bent section of a canal
        ...
        'CNLN':{'waterway':'canal', 'service':'navigation(s)'}, //  navigation canal(s): a watercourse constructed for navigation of vessels
        ...
        'CNLX':{'poi:type':'section_of_canal'}, //  section of canal: 
        'CNS':{'poi:type':'concession_area'}, //  concession area: a lease of land by a government for economic development, e.g., mining, forestry
        'CNSU':{'geological':'canyon'}, //  canyons: relatively narrow, deep depressions with steep sides, the bottom of which generally has a continuous slope
        'CNYN':{'geological':'canyon'}, //  canyon: a deep, narrow valley with steep sides cutting into a plateau or mountainous area
        'CNYU':{'geological':'canyon'}, //  canyon: a relatively narrow, deep depression with steep sides, the bottom of which generally has a continuous slope
        ...
        'CRDR':{'poi:type':'corridor'}, //  corridor: a strip or area of land having significance as an access way
        'CRKT':{'poi:type':'tidal_creek(s)'}, //  tidal creek(s): a meandering channel in a coastal wetland subject to bi-directional tidal currents
        'CRNT':{'poi:type':'current'}, //  current: a horizontal flow of water in a given direction with uniform velocity
        'CRQ':{'glacier:type':'cirque'}, //  cirque: a bowl-like hollow partially surrounded by cliffs or steep slopes at the head of a glaciated valley
        'CRQS':{'glacier:type':'cirque'}, //  cirques: bowl-like hollows partially surrounded by cliffs or steep slopes at the head of a glaciated valley
        'CRRL':{'man_made':'corral'}, //  corral(s): a pen or enclosure for confining or capturing animals
        'CRSU':{'geological':'continental_rise'}, //  continental rise: a gentle slope rising from oceanic depths towards the foot of a continental slope
        ...
        'CST':{'poi:type':'coast'}, //  coast: a zone of variable width straddling the shoreline
        ...
        'CULT':{'poi:type':'cultivated_area'}, //  cultivated area: an area under cultivation
        'CUTF':{'poi:type':'cutoff'}, //  cutoff: a channel formed as a result of a stream cutting through a meander neck
        ...
        'DEPU':{'poi:type':'deep'}, //  deep: a localized deep area within the confines of a larger feature, such as a trough, basin or trench
        ...
        'DOMG':{'glacier:type':'icecap_dome'}, //  icecap dome: a comparatively elevated area on an icecap
        'DPOF':{'amenity':'fuel_storage'}, //  fuel depot: an area where fuel is stored
        'DPRG':{'poi:type':'icecap_depression'}, //  icecap depression: a comparatively depressed area on an icecap
        ...
        'DTCHM':{'poi:type':'ditch_mouth'}, //  ditch mouth(s): an area where a drainage ditch enters a lagoon, lake or bay
        ...
        'DVD':{'poi:type':'divide'}, //  divide: a line separating adjacent drainage basins
        'EDGU':{'poi:type':'shelf_edge'}, //  shelf edge: a line along which there is a marked increase of slope at the outer margin of a continental shelf or island shelf
        'ERG':{'natural':'desert', 'desert':'erg'}, //  sandy desert: an extensive tract of shifting sand and sand dunes
        'ESCU':{'poi:type':'escarpment'}, //  escarpment (or scarp): an elongated and comparatively steep slope separating flat or gently sloping areas
        'ESTO':{'place':'farm', 'produce':'oil_palm'}, //  oil palm plantation: an estate specializing in the cultivation of oil palm trees
        'EST':{'poi:type':'estate'}, //  estate(s): a large commercialized agricultural landholding with associated buildings and other facilities
        'ESTR':{'place':'farm', 'produce':'rubber'}, //  rubber plantation: an estate which specializes in growing and tapping rubber trees
        'ESTSG':{'place':'farm', 'produce':'sugar'}, //  sugar plantation: an estate that specializes in growing sugar cane
        'ESTT':{'place':'farm', 'produce':'tea'}, //  tea plantation: an estate which specializes in growing tea bushes
        'ESTX':{'poi:type':'section_of_estate'}, //  section of estate: 
        ...
        'FANU':{'geological':'fan'}, //  fan: a relatively smooth feature normally sloping away from the lower termination of a canyon or canyon system
        ...
        'FLTU':{'poi:type':'flat'}, //  flat: a small level or nearly level area
        ...
        'FRSTF':{'poi:type':'fossilized_forest'}, //  fossilized forest: a forest fossilized by geologic processes and now exposed at the earth's surface
        'FRST':{'landuse':'forest'}, //  forest(s): an area dominated by tree vegetation
        'FRZU':{'geological':'fracture_zone'}, //  fracture zone: an extensive linear zone of irregular topography of the sea floor, characterized by steep-sided or asymmetrical ridges, troughs, or escarpments
        'FSR':{'natural':'volcano'}, //  fissure: a crack associated with volcanism
        'FT':{'building':'fort'}, //  fort: a defensive structure or earthworks
        'FURU':{'poi:type':'furrow'}, //  furrow: a closed, linear, narrow, shallow depression
        ...
        'GAP':{'poi:type':'gap'}, //  gap: a low place in a ridge, not used for transportation
        'GAPU':{'poi:type':'gap'}, //  gap: a narrow break in a ridge or rise
        ...
        'GHAT':{'poi:type':'ghat'}, //  ghat: a set of steps leading to a river, which are of religious significance, and at their base is usually a platform for bathing
        ...
        'GLYU':{'natural':'gully'}, //  gully: a small valley-like feature
        'GOSP':{'landuse':'gas-oil_separation'}, //  gas-oil separator plant: a facility for separating gas from oil
        ...
        'GRVC':{'trees':'coconut_palm'}, //  coconut grove: a planting of coconut trees
        'GRVE':{'landuse':'cemetery'}, //  grave: a burial site
        'GRVO':{'trees':'olive_trees'}, //  olive grove: a planting of olive trees
        'GRVPN':{'trees':'pine_trees'}, //  pine grove: a planting of pine trees
        'GRVP':{'trees':'palm_trees'}, //  palm grove: a planting of palm trees
        ...
        'HLLU':{'natural':'hill'}, //  hill: an elevation rising generally less than 500 meters
        'HLSU':{'natural':'hill'}, //  hills: elevations rising generally less than 500 meters
        'HLT':{'poi:type':'halting_place'}, //  halting place: a place where caravans stop for rest
        'HMCK':{'poi:type':'hammock(s)'}, //  hammock(s): a patch of ground, distinct from and slightly above the surrounding plain or wetland. Often occurs in groups
        ...
        'HOLU':{'poi:type':'hole'}, //  hole: a small depression of the sea floor
        ...
        'INLTQ':{'poi:type':'former_inlet'}, //  former inlet: an inlet which has been filled in, or blocked by deposits
        'INSM':{'military':'military_installation'}, //  military installation: a facility for use of and control by armed forces
        'INTF':{'poi:type':'interfluve'}, //  interfluve: a relatively undissected upland between adjacent stream valleys
        ...
        'ISLM':{'poi:type':'mangrove_island'}, //  mangrove island: a mangrove swamp surrounded by a waterbody
        ...
        'ISLT':{'poi:type':'land-tied_island'}, //  land-tied island: a coastal island connected to the mainland by barrier beaches, levees or dikes
        'ISLX':{'natural':'island'}, //  section of island: 
        'ISTH':{'poi:type':'isthmus'}, //  isthmus: a narrow strip of land connecting two larger land masses and bordered by water
        ...
        'KNLU':{'poi:type':'knoll'}, //  knoll: an elevation rising generally more than 500 meters and less than 1,000 meters and of limited extent across the summit
        'KNSU':{'poi:type':'knolls'}, //  knolls: elevations rising generally more than 500 meters and less than 1,000 meters and of limited extent across the summits
        ...
        'LAND':{'poi:type':'arctic_land'}, //  arctic land: a tract of land in the Arctic
        'LAVA':{'natural':'lava'}, //  lava area: an area of solidified lava
        'LBED':{'poi:type':'lake_bed'}, //  lake bed(s): a dried up or drained area of a former lake
        'LCTY':{'place':'locality'}, //  locality: a minor area or place of unspecified or mixed character and indefinite boundaries
        'LDGU':{'poi:type':'ledge'}, //  ledge: a rocky projection or outcrop, commonly linear and near shore
        ...
        'LEVU':{'man_made':'dyke'}, //  levee: an embankment bordering a canyon, valley, or seachannel
        ...
        'LGNS':{'water':'lagoons'}, //  lagoons: shallow coastal waterbodies, completely or partly separated from a larger body of water by a barrier island, coral reef or other depositional feature
        ...
        'LTER':{'poi:type':'leased_area'}, //  leased area: a tract of land leased to another country, usually for military installations
        ...
        'MESA':{'poi:type':'mesa'}, //  mesa(s): a flat-topped, isolated elevation with steep slopes on all sides, less extensive than a plateau
        'MESU':{'poi:type':'mesa'}, //  mesa: an isolated, extensive, flat-topped elevation on the shelf, with relatively steep sides
        ...
        'MND':{'poi:type':'mound(s)'}, //  mound(s): a low, isolated, rounded hill
        'MNDU':{'poi:type':'mound'}, //  mound: a low, isolated, rounded hill
        ...
        'MOTU':{'water':'moat'}, //  moat: an annular depression that may not be continuous, located at the base of many seamounts, islands, and other isolated elevations
        'MRN':{'geological':'moraine'}, //  moraine: a mound, ridge, or other accumulation of glacial till
        'MRSHN':{'wetland':'saltmarsh'}, //  salt marsh: a flat area, subject to periodic salt water inundation, dominated by grassy salt-tolerant plants
        'MRSH':{'wetland':'marsh'}, //  marsh(es): a wetland dominated by grass-like vegetation
        ...
        'MSTY':{'poi:type':'monastery'}, //  monastery: a building and grounds where a community of monks lives in seclusion
        ...
        'MTU':{'natural':'mountain'}, //  mountain: a well-delineated subdivision of a large and complex positive feature
        ...
        'NKM':{'poi:type':'meander_neck'}, //  meander neck: a narrow strip of land between the two limbs of a meander loop at its narrowest point
        ...
        'NTK':{'poi:type':'nunatak'}, //  nunatak: a rock or mountain peak protruding through glacial ice
        'NTKS':{'poi:type':'nunataks'}, //  nunataks: rocks or mountain peaks protruding through glacial ice
        ...
        'OILJ':{'poi:type':'oil_pipeline_junction'}, //  oil pipeline junction: a section of an oil pipeline where two or more pipes join together
        ...
        'OVF':{'poi:type':'overfalls'}, //  overfalls: an area of breaking waves caused by the meeting of currents or by waves moving against the current
        'PAL':{'building':'palace'}, //  palace: a large stately house, often a royal or presidential residence
        'PAN':{'poi:type':'pan'}, //  pan: a near-level shallow, natural depression or basin, usually containing an intermittent lake, pond, or pool
        'PANS':{'poi:type':'pans'}, //  pans: a near-level shallow, natural depression or basin, usually containing an intermittent lake, pond, or pool
        ...
        'PCLD':{'poi:type':'dependent_political_entity'}, //  dependent political entity: 
        ...
        'PENX':{'poi:type':'section_of_peninsula'}, //  section of peninsula: 
        ...
        'PKSU':{'natural':'peak'}, //  peaks: prominent elevations, part of a larger feature, either pointed or of very limited extent across the summit
        'PKU':{'natural':'peak'}, //  peak: a prominent elevation, part of a larger feature, either pointed or of very limited extent across the summit
        'PLAT':{'landform':'plateau'}, //  plateau: an elevated plain with steep slopes on one or more sides, and often with incised streams
        'PLATX':{'poi:type':'section_of_plateau'}, //  section of plateau: 
        'PLDR':{'landform':'polder'}, //  polder: an area reclaimed from the sea by diking and draining
        'PLN':{'landform':'plain'}, //  plain(s): an extensive area of comparatively level to gently undulating land, lacking surface irregularities, and usually adjacent to a higher area
        'PLNU':{'landform':'plain'}, //  plain: a flat, gently sloping or nearly level region
        'PLNX':{'landform':'section_of_plain'}, //  section of plain: 
        'PLTU':{'landform':'plateau'}, //  plateau: a comparatively flat-topped feature of considerable extent, dropping off abruptly on one or more sides
        ...
        'PNDNI':{'poi:type':'intermittent_salt_pond(s)'}, //  intermittent salt pond(s): 
        'PNDN':{'poi:type':'salt_pond'}, //  salt pond: a small standing body of salt water often in a marsh or swamp, usually along a seacoast
        ...
        'PNLU':{'landmark':'rock_pinnacle'}, //  pinnacle: a high tower or spire-shaped pillar of rock or coral, alone or cresting a summit
        'POOLI':{'poi:type':'intermittent_pool'}, //  intermittent pool: 
        'POOL':{'poi:type':'pool(s)'}, //  pool(s): a small and comparatively still, deep part of a larger body of water such as a stream or harbor; or a small body of standing water
        ...
        'PPLA2':{'poi:type':'seat_of_a_second-order_administrative_division'}, //  seat of a second-order administrative division: 
        'PPLA3':{'poi:type':'seat_of_a_third-order_administrative_division'}, //  seat of a third-order administrative division: 
        'PPLA4':{'poi:type':'seat_of_a_fourth-order_administrative_division'}, //  seat of a fourth-order administrative division: 
        'PPLA':{'poi:type':'seat_of_a_first-order_administrative_division'}, //  seat of a first-order administrative division: seat of a first-order administrative division (PPLC takes precedence over PPLA)
        ...
        'PPLG':{'poi:type':'seat_of_government_of_a_political_entity'}, //  seat of government of a political entity: 
        ...
        'PPLL':{'poi:type':'populated_locality'}, //  populated locality: an area similar to a locality but with a small group of dwellings or other buildings
        'PPL':{'place':'populated'}, //  populated place: a city, town, village, or other agglomeration of buildings where people live and work
        'PPL':{'poi:type':'populated_place'}, //  populated place: a city, town, village, or other agglomeration of buildings where people live and work
        'PPLQ':{'abandoned:place':'populated'}, //  abandoned populated place: 
        'PPLR':{'amenity':'religious_community'}, //  religious populated place: a populated place whose population is largely engaged in religious occupations
        ...
        'PRMN':{'poi:type':'promenade'}, //  promenade: a place for public walking, usually along a beach front
        ...
        'PROM':{'poi:type':'promontory(-ies)'}, //  promontory(-ies): a bluff or prominent hill overlooking or projecting into a lowland
        ...
        'PRVU':{'place':'province'}, //  province: a region identifiable by a group of similar physiographic features whose characteristics are markedly in contrast with surrounding areas
        ...
        'PT':{'poi:type':'point'}, //  point: a tapering piece of land projecting into a body of water, less prominent than a cape
        'PTS':{'poi:type':'points'}, //  points: tapering pieces of land projecting into a body of water, less prominent than a cape
        ...
        'QUAY':{'man_made':'peir'}, //  quay: a structure of solid construction along a shore or bank which provides berthing for ships and which generally provides cargo handling facilities
        'RCH':{'poi:type':'reach'}, //  reach: a straight section of a navigable stream or channel between two bends
        'RDA':{'historic':'road'}, //  ancient road: the remains of a road used by ancient cultures
        'RDB':{'poi:type':'road_bend'}, //  road bend: a conspicuously curved or bent section of a road
        ...
        'RDGU':{'natural':'ridge'}, //  ridge: a long narrow elevation with steep sides
        ...
        'RDST':{'poi:type':'roadstead'}, //  roadstead: an open anchorage affording less protection than a harbor
        'RDSU':{'natural':'ridge'}, //  ridges: long narrow elevations with steep sides
        ...
        'RISU':{'poi:type':'rise'}, //  rise: a broad elevation that rises gently, and generally smoothly, from the sea floor
        'RJCT':{'railway':'rail', 'junction':'yes'}, //  railroad junction: a place where two or more railroad tracks join
        'RKFL':{'poi:type':'rockfall'}, //  rockfall: an irregular mass of fallen rock at the base of a cliff or steep slope
        ...
        'RSTPQ':{'poi:type':'abandoned_railroad_stop'}, //  abandoned railroad stop: 
        ...
        'SALT':{'poi:type':'salt_area'}, //  salt area: a shallow basin or flat where salt accumulates after periodic inundation
        'SAND':{'natural':'sand'}, //  sand area: a tract of land covered with sand
        'SBED':{'poi:type':'dry_stream_bed'}, //  dry stream bed: a channel formerly containing the water of a stream
        ...
        'SCNU':{'poi:type':'seachannel'}, //  seachannel: a continuously sloping, elongated depression commonly found in fans or plains and customarily bordered by levees on one or two sides
        'SCRB':{'natural':'scrub'}, //  scrubland: an area of low trees, bushes, and shrubs stunted by some environmental limitation
        'SCRP':{'poi:type':'escarpment'}, //  escarpment: a long line of cliffs or steep slopes separating level surfaces above and below
        'SCSU':{'poi:type':'seachannels'}, //  seachannels: continuously sloping, elongated depressions commonly found in fans or plains and customarily bordered by levees on one or two sides
        'SDL':{'natural':'saddle'}, //  saddle: a broad, open pass crossing a ridge or between hills or mountains
        'SDLU':{'natural':'saddle'}, //  saddle: a low part, resembling in shape a saddle, in a ridge or between contiguous seamounts
        ...
        'SHFU':{'natural':'continental_shelf'}, //  shelf: a zone adjacent to a continent (or around an island) that extends from the low water line to a depth at which there is usually a marked increase of slope towards oceanic depths
        ...
        'SHPF':{'poi:type':'sheepfold'}, //  sheepfold: a fence or wall enclosure for sheep and other small herd animals
        ...
        'SHSU':{'natural':'shoal'}, //  shoals: hazards to surface navigation composed of unconsolidated material
        'SHVU':{'poi:type':'shelf_valley'}, //  shelf valley: a valley on the shelf, generally the shoreward extension of a canyon
        'SILL':{'poi:type':'sill'}, //  sill: the low part of an underwater gap or saddle separating basins, including a similar feature at the mouth of a fjord
        'SILU':{'poi:type':'sill'}, //  sill: the low part of a gap or saddle separating basins
        ...
        'SLID':{'poi:type':'slide'}, //  slide: a mound of earth material, at the base of a slope and the associated scoured area
        'SLP':{'slope':'yes'}, //  slope(s): a surface with a relatively uniform slope angle
        'SLPU':{'slope':'yes'}, //  slope: the slope seaward from the shelf edge to the beginning of a continental rise or the point where there is a general reduction in slope
        ...
        'SPRU':{'natural':'spur'}, //  spur: a subordinate elevation, ridge, or rise projecting outward from a larger feature
        ...
        'STMIX':{'poi:type':'section_of_intermittent_stream'}, //  section of intermittent stream: 
        ...
        'STMQ':{'poi:type':'abandoned_watercourse'}, //  abandoned watercourse: a former stream or distributary no longer carrying flowing water, but still evident due to lakes, wetland, topographic or vegetation patterns
        ...
        'STMX':{'poi:type':'section_of_stream'}, //  section of stream: 
        ...
        'SWMP':{'wetland':'swamp'}, //  swamp: a wetland dominated by tree vegetation
        ...
        'TERU':{'poi:type':'terrace'}, //  terrace: a relatively flat horizontal or gently inclined surface, sometimes long and narrow, which is bounded by a steeper ascending slope on one side and by a steep descending slope on the opposite side
        ...
        'TMSU':{'poi:type':'tablemounts_(or_guyots)'}, //  tablemounts (or guyots): seamounts having a comparatively smooth, flat top
        'TMTU':{'poi:type':'tablemount_(or_guyot)'}, //  tablemount (or guyot): a seamount having a comparatively smooth, flat top
        'TNGU':{'poi:type':'tongue'}, //  tongue: an elongate (tongue-like) extension of a flat sea floor into an adjacent higher feature
        ...
        'TNLS':{'poi:type':'tunnels'}, //  tunnels: subterranean passageways for transportation
        ...
        'TRGU':{'poi:type':'trough'}, //  trough: a long depression of the sea floor characteristically flat bottomed and steep sided, and normally shallower than a trench
        ...
        'TRNU':{'poi:type':'trench'}, //  trench: a long, narrow, characteristically very deep and asymmetrical depression of the sea floor, with relatively steep sides
        'TRR':{'poi:type':'terrace'}, //  terrace: a long, narrow alluvial platform bounded by steeper slopes above and below, usually overlooking a waterbody
        ...
        'USGE':{'poi:type':'united_states_government_establishment'}, //  united states government establishment: a facility operated by the United States Government in Panama
        ...
        'VALS':{'natural':'valley'}, //  valleys: elongated depressions usually traversed by a stream
        'VALU':{'natural':'valley'}, //  valley: a relatively shallow, wide depression, the bottom of which usually has a continuous gradient
        ...
        'VLSU':{'natural':'valley'}, //  valleys: a relatively shallow, wide depression, the bottom of which usually has a continuous gradient
        'WADB':{'waterway':'wadi', 'water:morphology':'bend'}, //  wadi bend: a conspicuously curved or bent segment of a wadi
        'WADJ':{'poi:type':'wadi_junction'}, //  wadi junction: a place where two or more wadies join
        ...
        'WADX':{'waterway':'wadi'}, //  section of wadi: 
