...
//     'FCSUBTYPE':'etds:fcsubtype', // eLTDS40 Field. Very ESRI Specific. Ignored for now
     ...
     'VLM':'volume', // Volume
     'VST':'raw:VST', // Vehicle Scale Count
     ...
     */
     ...
     ['CON','20','raw:CON','avalanche_protector'], // Gallery
     ...
     ['CON','41','raw:CON','transportation_route_protection_structure'], // Traneportation Route Protection Structure
...
*/
     ...
     ['SRE','4','raw:SRE','sharp_curve'], // Sharp Curve
     ['SRE','5','raw:SRE','steep_grade'], // Steep Grade
     ['SRE','8','raw:SRE','sharp_curves'], // Sharp Curves
     ['SRE','9','raw:SRE','steep_curves'], // Steep Curves
