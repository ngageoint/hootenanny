...
#### Merges two OSM features using Hootenanny conflation.  Currently supports merging POIs with POIs, POIs with polygons, areas with areas,
#### or buildings with buildings.
___
## POST /elementmerge
