...
etds40_osm = {
    ...
    toOSM : function(attrs, elementType, geometryType)
    {
        ...
        {
            if (val in etds_osm_rules.singleValues)
            {
                nAttrs[etds_osm_rules.singleValues[val]] = attrs[val];
                // Debug
                // print('Single: ' + etds_osm_rules.singleValues[val] + ' = ' + attrs[val])
        ...
        translate.applyOne2One(attrs, nAttrs, etds_osm_rules.enumValues, {'k':'v'});
