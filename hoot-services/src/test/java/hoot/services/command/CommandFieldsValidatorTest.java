...
public class CommandFieldsValidatorTest {
    private static final File testFolder = new File(FileUtils.getTempDirectory(), "CommandFieldsValidatorTest");
    private static String originalHomeFolderDir;

    @BeforeClass
    public static void beforeClass() throws Exception {
        URL inputUrl = CommandFieldsValidatorTest.class.getResource("/hoot/services/command/services_fields_metadata.json");
    ...
    public void testValidateRequiredExists() throws Exception {
        CommandFieldsValidator validator = new CommandFieldsValidator("ConflationResource");
        ...
        validator = new CommandFieldsValidator("CookieCutterResource");
        ...
        validator = new CommandFieldsValidator("ETLResource");
        ...
        validator = new CommandFieldsValidator("ExportResource");
        ...
        validator = new CommandFieldsValidator("TranslatorResource");
