...
public class JobResourceTest {
    ...
    public void testprocessChainJob() throws Exception {
        ...
        Mockito.doNothing().when(mockJobStatusManager).updateJob(org.mockito.Matchers.anyString(),
                org.mockito.Matchers.anyString());
        Mockito.doNothing().when(mockJobStatusManager).setComplete(org.mockito.Matchers.anyString(),
                org.mockito.Matchers.anyString());
        Mockito.doNothing().when(mockJobStatusManager).setFailed(org.mockito.Matchers.anyString(),
                org.mockito.Matchers.anyString());
        ...
        org.mockito.Mockito.doReturn(new JSONObject()).when(spy)._processJob(org.mockito.Matchers.anyString(),
                org.mockito.Matchers.any(JSONObject.class));

        org.mockito.Mockito.when(spy._createJobStatusMananger(org.mockito.Matchers.any(java.sql.Connection.class)))
                .thenReturn(mockJobStatusManager);
        ...
        org.mockito.Mockito.verify(spy)._execReflection(Matchers.matches("test_job_id_1234"),
                org.mockito.Matchers.argThat(new validParam2Matcher()),
                org.mockito.Matchers.any(JobStatusManager.class));

        ArgumentCaptor<String> argCaptor = ArgumentCaptor.forClass(String.class);

        org.mockito.Mockito.verify(mockJobStatusManager, org.mockito.Mockito.times(3))
                .updateJob(org.mockito.Matchers.anyString(), argCaptor.capture());
        ...
        org.mockito.Mockito.verify(mockJobStatusManager, org.mockito.Mockito.times(1))
                .setComplete(org.mockito.Matchers.anyString(), setCompleteArgCaptor.capture());
    ...
    public void testprocessChainJobFailure() throws Exception {
        ...
        // failure point
        org.mockito.Mockito
                .doThrow(new Exception("Mock failure for testing Process Chain Job failure. (Not real failure!!!)"))
                .when(spy)._execReflection(org.mockito.Matchers.anyString(), org.mockito.Matchers.any(JSONObject.class),
                        org.mockito.Matchers.any(JobStatusManager.class));
        ...
        org.mockito.Mockito.verify(mockJobStatusManager, org.mockito.Mockito.times(2))
                .updateJob(org.mockito.Matchers.anyString(), argCaptor.capture());
        ...
        org.mockito.Mockito.verify(mockJobStatusManager, org.mockito.Mockito.times(1))
                .setFailed(org.mockito.Matchers.anyString(), setFailedArgCaptor.capture());
        ...
        child = (JSONObject) children.get(0);
        Assert.assertEquals(child.get("detail").toString(),
                "Mock failure for testing Process Chain Job failure. (Not real failure!!!)");
    ...
    public void testGetJobStatus() throws Exception {
        ...
        org.mockito.Mockito.when(spy._getProgressText(org.mockito.Matchers.anyString()))
                .thenReturn(mockProgressInfo.toJSONString());
