...
public class CustomScriptGetListProcessletTest {
	...
	public void testProcess() throws Exception
	{
		...
		doThrow(new Exception("Mock Test Error for CustomScriptGetListProcessletTest. (Not real error)")).when(processlet).getRequest();
    ...
    final String responseStr = 
        ((LiteralOutputImpl)out.getParameter("SCRIPT_LIST")).getValue();
    
    assertTrue(responseStr.equals("Failed: Mock Test Error for CustomScriptGetListProcessletTest. (Not real error)"));
