...
public class ChangesetResourceUploadCommonTest extends OsmResourceTestAbstract
{
  ...
  public void testUploadMultipleChangesets() throws Exception
  {
    ...
    //Upload more than one changeset in the same request.  A failure should occur and no data in the
    ...
    catch (UniformInterfaceException e)
    {
      ...
      Assert.assertTrue(
        r.getEntity(String.class).contains("Only one changeset may be uploaded at a time"));
  ...
  public void testUploadBadXml() throws Exception
  {
    ...
    //Upload a changeset with malformed XML.  A failure should occur and no data in the system
    //should be modified.
    try
    {
      resource()
  ...
  public void testUploadEmptyChangeset() throws Exception
  {
    ...
    //Upload a changeset with no items in it.  A failure should occur and no data in the system
    //should be modified.
    try
    {
      resource()
