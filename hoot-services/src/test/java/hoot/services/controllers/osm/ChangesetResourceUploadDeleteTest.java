...
public class ChangesetResourceUploadDeleteTest extends OsmResourceTestAbstract {
    ...
    private void testUploadDelete(String request, BoundingBox originalBounds,
                                  long changesetId, Long[] nodeIdsArr, Long[] wayIdsArr,
                                  Long[] relationIdsArr)
    throws Exception {
        try {
            ...
            try {
                ...
                Assert.assertEquals(
                        nodeIdsArr[0], member.getMemberId());
            ...
            try {
                ...
                Changeset hootChangeset =
                        new Changeset(mapId, changesetId, conn);
    ...
    public void testUploadDelete2() throws Exception {
        try {
            ...
            //Now delete two of the nodes, where ways are specified in the modify portion of the request
            //before the nodes.
            Document responseData = null;
            try {
                responseData =
                        ...
                        resource()
                                ...
                                .post(
                                        ...
                                        "<osmChange version=\"0.3\" generator=\"iD\">" +
                                                ...
                                                "<tag k=\"key 1\" v=\"val 1\"></tag>" +
                                                "</way>" +
                                                "<relation id=\"" + relationIdsArr[1] + "\" version=\"1\" " +
                                                "changeset=\"" + changesetId + "\">" +
                                                "</relation>" +
                                                "</delete>" +
                                                "</osmChange>");
    ...
    public void testUploadDeleteNonExistingNode() throws Exception {
        ...
        //Try to delete a node in the changeset that doesn't exist.  A failure should occur
            ...
            resource()
                    ...
                    .post(
                            ...
                            "<osmChange version=\"0.3\" generator=\"iD\">" +
                                    ...
                                    changesetId + "\">" +
                                    "</node>" +
                                    "<node id=\"" + (nodeIdsArr[4] + 1) + "\" lon=\"" + updateBounds.getMinLon() + "\" " +
    ...
    public void testUploadDeleteNonExistingWay() throws Exception {
        ...
        //Try to delete a way in the changeset that doesn't exist.  A failure should occur
        //and no data in the system should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
    ...
    public void testUploadDeleteNonExistingRelation() throws Exception {
        ...
        //Try to delete a relation in the changeset that doesn't exist.  A failure should occur
        //and no data in the system should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
                    ...
                    .post(
                            ...
                            "<osmChange version=\"0.3\" generator=\"iD\">" +
                                    ...
                                    "</relation>" +
                                    "<relation id=\"" + (relationIdsArr[3] + 1) + "\" version=\"1\" changeset=\"" + changesetId + "\">" +
                                    "</relation>" +
                                    "</delete>" +
                                    "</osmChange>");
        }
    ...
    public void testUploadDeleteDuplicateNodeIds() throws Exception {
        ...
        //Try to delete two nodes with the same ID.  A failure should occur and no data in the system
        //should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
    ...
    public void testUploadDeleteDuplicateWayIds() throws Exception {
        ...
        //Try to delete two ways with the same ID.  A failure should occur and no data in the system
        //should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
    ...
    public void testUploadDeleteDuplicateRelationIds() throws Exception {
        ...
        //Try to delete two relations with the same ID.  A failure should occur and no data in the
            ...
            resource()
                    ...
                    .post(
                            ...
                            "<osmChange version=\"0.3\" generator=\"iD\">" +
                                    ...
                                    "<modify/>" +
                                    "<delete if-unused=\"true\">" +
                                    "<relation id=\"" + relationIdsArr[3] + "\" version=\"1\" changeset=\"" +
                                    changesetId + "\">" +
                                    "<member type=\"way\" role=\"role1\" ref=\"" + wayIdsArr[2] + "\"></member>" +
                                    "<member type=\"way\" role=\"role1\" ref=\"" + wayIdsArr[1] + "\"></member>" +
                                    "<tag k=\"key 1\" v=\"val 1\"></tag>" +
            ...
            resource()
                    ...
                    .post(
                            ...
                            "<osmChange version=\"0.3\" generator=\"iD\">" +
                                    ...
                                    "</node>" +
                                    "<node id=\"" + nodeIdsArr[4] + "\" lon=\"" + originalBounds.getMinLon() + "\" " +
                                    "lat=\"" + originalBounds.getMinLat() + "\" version=\"2\" changeset=\"" +
                                    changesetId + "\">" +
                                    "<tag k=\"key 3\" v=\"val 3\"></tag>" +
                                    "</node>" +
                                    "</delete>" +
    ...
    public void testUploadDeleteNegativeElementId() throws Exception {
        try {
            ...
            CurrentWays insertedWayRecord =
                    new SQLQuery(conn, DbUtils.getConfiguration(mapId)).from(currentWaysTbl)
                            .where(currentWaysTbl.id.eq(new Long(negativeWayId)))
                            .singleResult(currentWaysTbl);
    ...
    public void testUploadDeleteMissingNodeTagValue() throws Exception {
        try {
            ...
            //Now delete some nodes with an update to the changeset.  One of the nodes being deleted
            //does not have its tag value specified.  The test should pass b/c node tags are optional for
    ...
    public void testUploadDeleteMissingWayTagValue() throws Exception {
        try {
            ...
            //Now delete some ways with an update to the changeset.  One of the ways being deleted
            //does not have its tag value specified.  The test should pass b/c way tags are optional for
            //a delete and not parsed.
            Document responseData = null;
            try {
                responseData =
    ...
    public void testUploadDeleteMissingRelationTagValue() throws Exception {
        try {
            ...
            //Now delete some relations with an update to the changeset.  One of the relations being
            //deleted does not have its tag value specified.  The test should pass b/c tags are optional
            ...
            try {
                ...
                org.w3c.dom.Node xml =
                        XPathAPI.selectSingleNode(responseData, "//osm/diffResult/relation[1]");
                Assert.assertNull(xml.getAttributes().getNamedItem("new_id"));
                Assert.assertNull(xml.getAttributes().getNamedItem("new_version"));
                Assert.assertEquals(
                        (long) relationIdsArr[3],
                        Long.parseLong(xpath.evaluate("//osm/diffResult/relation[2]/@old_id",
                                responseData)));
                xml = XPathAPI.selectSingleNode(responseData, "//osm/diffResult/relation[2]");
                Assert.assertNull(xml.getAttributes().getNamedItem("new_id"));
    ...
    public void testUploadDeleteWayInvalidVersion() throws Exception {
        ...
        //Send a changeset delete request where one of the ways has a version not equal to what's
        //on the server.  A failure should occur and no data in the system should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
                    .queryParam("mapId", "" + mapId)
    ...
    public void testUploadDeleteRelationInvalidVersion() throws Exception {
        ...
        //Send a changeset delete request where one of the relations has a version not equal to what's
        //on the server.  A failure should occur and no data in the system should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
    ...
    public void testUploadDeleteNodeStillBelongsToWayWithIfUnused() throws Exception {
        try {
            ...
            //Try to delete some elements with the "if-unused" tag is passed where one of them is a node
            //that still belongs to a way.  No failure should occur, the node should not be deleted, and
            ...
            try {
                ...
                Assert.assertNull(
                        new SQLQuery(conn, DbUtils.getConfiguration(mapId)).from(currentWaysTbl)
                                .where(currentWaysTbl.id.eq(new Long(wayIdsArr[2])))
                                .singleResult(currentWaysTbl)
                );
            }
            catch (Exception e) {
            ...
            OsmTestUtils.verifyTestRelationsUnmodified(
                    relationIds, wayIds, nodeIds, changesetId);
            ...
            try {
                ...
                Assert.assertTrue(changeset.getCreatedAt().before(now));
                Assert.assertTrue(changeset.getClosedAt().after(changeset.getCreatedAt()));
                Assert.assertEquals(new Integer(1), changeset.getNumChanges());
                Assert.assertEquals(new Long(userId), changeset.getUserId());
    ...
    public void testUploadDeleteNodeStillBelongsToRelationWithIfUnused() throws Exception {
        try {
            ...
            //Try to delete some elements with the "if-unused" tag is passed where one of them is a node
            //that still belongs to a relation.  No failure should occur, the node should not be deleted,
            ...
            try {
                List<CurrentRelations> relations =
                        new SQLQuery(conn, DbUtils.getConfiguration(mapId)).from(currentRelationsTbl)
    ...
    public void testUploadDeleteWayStillBelongsToRelationWithIfUnused() throws Exception {
        try {
            ...
            //Try to delete some elements with the "if-unused" tag is passed where one of them is a way
            //that still belongs to a relation.  No failure should occur, the way should not be deleted,
            //and the other element should be deleted.
            Document responseData = null;
            try {
                responseData =
    ...
    public void testUploadDeleteRelationStillBelongsToRelationWithIfUnused() throws Exception {
      ...
      /*final Set<Long> relationIds =*/
            OsmTestUtils.createTestRelations(changesetId, nodeIds, wayIds);
            final Long[] relationIdsArr = wayIds.toArray(new Long[]{});

            //Try to delete some elements with the "if-unused" tag is passed where one of them is a
            //relation that still belongs to a relation.  No failure should occur, the relation should
                        ...
                        resource()
                                ...
                                .post(
                                        ...
                                        "<osmChange version=\"0.3\" generator=\"iD\">" +
                                                ...
                                                "<modify/>" +
                                                "<delete if-unused=\"true\">" +
                                                "<relation id=\"" + relationIdsArr[0] + "\" version=\"1\" " +
                                                "changeset=\"" + changesetId + "\">" +
                                                "</relation>" +
                                                "<relation id=\"" + relationIdsArr[2] + "\" version=\"1\" " +
                                                "changeset=\"" + changesetId + "\">" +
    ...
    public void testUploadDeleteNodeStillBelongsToWayWithoutIfUnused() throws Exception {
        ...
        //Try to delete a node that still belongs to a way when the "if-unused" tag is not passed. A
    ...
    public void testUploadDeleteNodeStillBelongsToRelationWithoutIfUnused() throws Exception {
        ...
        //Try to delete a node that still belongs to a relation when the "if-unused" tag is not passed.
    ...
    public void testUploadDeleteWayStillBelongsToRelationWithoutIfUnused() throws Exception {
        ...
        //Try to delete a way that still belongs to a relation when the "if-unused" tag is not passed. A
        //failure should occur and no data in the system should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
    ...
    public void testUploadDeleteRelationStillBelongsToRelationWithoutIfUnused() throws Exception {
        ...
        //Try to delete a relation that still belongs to a relation when the "if-unused" tag is not
        //passed. A failure should occur and no data in the system should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
                    .queryParam("mapId", "" + mapId)
    ...
    public void testUploadDeleteRelationMissingMemberId() throws Exception {
        ...
        //Update the changeset with a relation that has a member with a missing ID attribute.  A
        //failure should occur and no data in the system should be modified.
        try {
            resource()
                    .path("api/0.6/changeset/" + changesetId + "/upload")
