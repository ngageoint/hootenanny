...
/*		class ReviewMockResultSet extends MockResultSet
		{
			...
			public ReviewMockResultSet()
			{
				...
				d.put("maxlon", -77.052043);
				d.put("maxlat", 38.902551);
				d.put("minlon", -77.052043);
				d.put("minlat", 38.902551);
				d.put("relation_id", (long)2);
				d.put("needreview", "yes");
				_mockData.add(d);
				
				d = new JSONObject();
				d.put("maxlon", -77.047465);
				d.put("maxlat", 38.895676);
				d.put("minlon", -77.047465);
				d.put("minlat", 38.895676);
				d.put("relation_id", (long)4);
				d.put("needreview", "yes");
				_mockData.add(d);
				
				d = new JSONObject();
				d.put("maxlon", -77.028118);
				d.put("maxlat", 38.892085);
				d.put("minlon", -77.028118);
				d.put("minlat", 38.892085);
				d.put("relation_id", (long)5);
				d.put("needreview", "yes");
				_mockData.add(d);
			...
			public double getDouble(String columnLabel) throws SQLException {
				return (double) _mockData.get(_currIdx).get(columnLabel);
			}
...
/*		class ReviewMockResultSet extends MockResultSet
		...
		AllReviewableItemsQuery spy = Mockito.spy(real);
		org.mockito.Mockito.doReturn(mockResult).when(spy)
			._execReviewableRelatioWithNodeMembersCentroidInBboxQuery(org.mockito.Matchers.any(java.sql.Statement.class));
		...
		Map<Long, ReviewableItemBboxInfo> res = spy._getReviewableRelatioWithNodeMembersCentroidInBbox();
...
/*		class ReviewMockResultSet extends MockResultSet
		{
			...
			public ReviewMockResultSet()
			{
				...
				JSONObject d = new JSONObject();
				d.put("member_id", (long)165);
				d.put("relation_id", (long)3);
				d.put("needreview", "yes");
				_mockData.add(d);
				
				d = new JSONObject();
				d.put("member_id", (long)27);
				d.put("relation_id", (long)3);
				d.put("needreview", "yes");
				_mockData.add(d);
				
				d = new JSONObject();
				d.put("member_id", (long)769);
				d.put("relation_id", (long)6);
				d.put("needreview", "yes");
				_mockData.add(d);
				
				d = new JSONObject();
				d.put("member_id", (long)628);
				d.put("relation_id", (long)6);
				d.put("needreview", "yes");
				_mockData.add(d);
			...
			public String getString(String columnLabel) throws SQLException {
				return (String) _mockData.get(_currIdx).get(columnLabel);
			}
		...
		org.mockito.Mockito.doReturn(mockResult).when(spy)
		._execReviewableRelationMembersQuery(org.mockito.Matchers.any(java.sql.Statement.class));
		...
		org.junit.Assert.assertTrue((long)165 == (long)o.get("memberid"));
		org.junit.Assert.assertTrue((long)3 == (long)o.get("relationid"));
		org.junit.Assert.assertTrue(o.get("needreview").toString().equals("yes"));
		
		o = res.get(1);
		org.junit.Assert.assertTrue((long)27 == (long)o.get("memberid"));
		org.junit.Assert.assertTrue((long)3 == (long)o.get("relationid"));
		org.junit.Assert.assertTrue(o.get("needreview").toString().equals("yes"));
		
		o = res.get(2);
		org.junit.Assert.assertTrue((long)769 == (long)o.get("memberid"));
...
/*		BoundingBox bbox = new BoundingBox();
		...
		._getReviewableRelationMembersCount(org.mockito.Matchers.matches("node"));
		
		org.mockito.Mockito.doReturn((long)0).when(spy)
		._getReviewableRelationMembersCount(org.mockito.Matchers.matches("way"));
		
		org.mockito.Mockito.doReturn((long)0).when(spy)
		._getReviewableRelationMembersCount(org.mockito.Matchers.matches("relation"));
		
		Map<Long, ReviewableItemBboxInfo> mockNodeResp = new HashMap<>();
		long relId = 2;
		String needReview = "yes";
		BoundingBox bbx = new BoundingBox(-77.052043, 38.902551, -77.052043, 38.902551);
		ReviewableItemBboxInfo info = new ReviewableItemBboxInfo(bbx, 0, relId, needReview);
		mockNodeResp.put(relId, info);
		
		relId = 4;
		needReview = "yes";
		bbx = new BoundingBox(-77.047465, 38.895676, -77.047465, 38.895676);
		info = new ReviewableItemBboxInfo(bbx, 0, relId, needReview);
		mockNodeResp.put(relId, info);
		...
		org.junit.Assert.assertEquals((long)0, resp.getReviewableItems().get((long)2).getMapId());
		org.junit.Assert.assertEquals((long)2, resp.getReviewableItems().get((long)2).getRelationId());
		org.junit.Assert.assertTrue(38.902551 == resp.getReviewableItems().get((long)2).getBbox().getMinLat());
		org.junit.Assert.assertTrue(38.902551 == resp.getReviewableItems().get((long)2).getBbox().getMaxLat());
		org.junit.Assert.assertTrue(-77.052043 == resp.getReviewableItems().get((long)2).getBbox().getMinLon());
		org.junit.Assert.assertTrue(-77.052043 == resp.getReviewableItems().get((long)2).getBbox().getMaxLon());
		
		org.junit.Assert.assertTrue(-77.052043 == resp.getReviewableItems().get((long)2).getBbox().getCenterX());
		org.junit.Assert.assertTrue(38.902551 == resp.getReviewableItems().get((long)2).getBbox().getCenterY());
		
		
		org.junit.Assert.assertEquals((long)0, resp.getReviewableItems().get((long)4).getMapId());
		org.junit.Assert.assertEquals((long)4, resp.getReviewableItems().get((long)4).getRelationId());
		org.junit.Assert.assertTrue(38.895676 == resp.getReviewableItems().get((long)4).getBbox().getMinLat());
		org.junit.Assert.assertTrue(38.895676 == resp.getReviewableItems().get((long)4).getBbox().getMaxLat());
		org.junit.Assert.assertTrue(-77.047465 == resp.getReviewableItems().get((long)4).getBbox().getMinLon());
...
/*		BoundingBox bbox = new BoundingBox();
		...
		Map<Long, ReviewableItemBboxInfo> mockWayResp = new HashMap<>();
		long relId = 2;
		String needReview = "yes";
		BoundingBox bbx = new BoundingBox(-77.052043, 38.902551, -77.052043, 38.902551);
		ReviewableItemBboxInfo info = new ReviewableItemBboxInfo(bbx, 0, relId, needReview);
...
/*		BoundingBox bbox = new BoundingBox(-104.912548,38.857832,-104.719153,38.875195);
		...
		List<JSONObject> mockReviewMems = new ArrayList<>();
		JSONObject d = new JSONObject();
		d.put("memberid", (long)165);
		d.put("relationid", (long)3);
		d.put("needreview", "yes");
		mockReviewMems.add(d);
		
		d = new JSONObject();
		d.put("memberid", (long)27);
		d.put("relationid", (long)3);
		d.put("needreview", "yes");
		mockReviewMems.add(d);
		
		d = new JSONObject();
		d.put("memberid", (long)769);
		d.put("relationid", (long)6);
		d.put("needreview", "yes");
		mockReviewMems.add(d);
		
		d = new JSONObject();
		d.put("memberid", (long)628);
		d.put("relationid", (long)6);
		d.put("needreview", "yes");
		mockReviewMems.add(d);
		...
		BoundingBox mockBbox = new BoundingBox(-77.052043, 38.902551, -77.012043, 38.992551);
		ReviewableItemBbox mockRelBbox = new ReviewableItemBbox(mockBbox,0, 165);
		org.mockito.Mockito.doReturn(mockRelBbox).when(spy)
		._getRelationMemberBbox(org.mockito.Matchers.eq((long)165));
		
		mockBbox = new BoundingBox(-104.720859, 38.874594, -104.719645, 38.874783);
		mockRelBbox = new ReviewableItemBbox(mockBbox,0, 27);
		org.mockito.Mockito.doReturn(mockRelBbox).when(spy)
		._getRelationMemberBbox(org.mockito.Matchers.eq((long)27));
		
		mockBbox = new BoundingBox(-104.719153, 38.875195, -104.717939, 38.875384);
		mockRelBbox = new ReviewableItemBbox(mockBbox,0, 769);
		org.mockito.Mockito.doReturn(mockRelBbox).when(spy)
		._getRelationMemberBbox(org.mockito.Matchers.eq((long)769));
		
		mockBbox = new BoundingBox(-104.9197586, 38.857832, -104.912548, 38.859302);
		mockRelBbox = new ReviewableItemBbox(mockBbox,0, 628);
		org.mockito.Mockito.doReturn(mockRelBbox).when(spy)
		...
		AllReviewableItems resp = (AllReviewableItems) spy.execQuery();
		org.junit.Assert.assertEquals(2, resp.getReviewableItems().size());
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)3).getMapId() == (long)10);
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)3).getRelationId() == (long)3);
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)3).getNeedReview().equals("yes"));
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)3).getBbox().getMinLat()==38.874594);
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)3).getBbox().getMinLon()==-104.720859);
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)3).getBbox().getMaxLat()==38.874783);
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)3).getBbox().getMaxLon()==-104.719645);
		
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)6).getMapId() == (long)10);
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)6).getRelationId() == (long)6);
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)6).getNeedReview().equals("yes"));
		org.junit.Assert.assertTrue(resp.getReviewableItems().get((long)6).getBbox().getMinLat()==38.857832);
