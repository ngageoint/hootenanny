...
public class JobFieldsValidatorTest {
	...
	{
		hoot.services.validators.job.JobFieldsValidator validator =  
				new hoot.services.validators.job.JobFieldsValidator("ConflationResource");
		...
		validator =  
				new hoot.services.validators.job.JobFieldsValidator("CookieCutterResource");
		...
		validator =  
				new hoot.services.validators.job.JobFieldsValidator("ETLResource");
		...
		validator =  
				new hoot.services.validators.job.JobFieldsValidator("ExportResource");
		...
		validator =  
				new hoot.services.validators.job.JobFieldsValidator("TranslatorResource");
		...
		validator =  
				new hoot.services.validators.job.JobFieldsValidator("ConflateProcesslet");
		actual = validator.validateField( "INPUT1_TYPE", "OSM");
		expected = true;
		Assert.assertEquals(actual, expected);
		...
		validator =  
				new hoot.services.validators.job.JobFieldsValidator("CookieCutterProcesslet");
		actual = validator.validateField( "INPUT1_TYPE", "OSM");
		expected = true;
		Assert.assertEquals(actual, expected);
		...
		validator =  
				new hoot.services.validators.job.JobFieldsValidator("ETLProcesslet");
		...
		validator =  
				new hoot.services.validators.job.JobFieldsValidator("LTDSTranslateProcesslet");
