...
class CommandFieldsValidator {
    private static final Logger logger = LoggerFactory.getLogger(CommandFieldsValidator.class);
    ...
    CommandFieldsValidator(String resourceName) {
        this.resourceName = resourceName;
    }

    boolean validateRequiredExists(Map<String, String> fields, List<String> missingList) {
