 ...
 * 
 * Inheritors are responsible for transforming input parameters into strings, which are then
 * passed to the validateAndParseParamValueString method.
 */
public abstract class InputParamsValidatorAbstract
{
   ...
   * 
   * @param paramValueStr parameter value
   ...
   * @throws Exception
   */
  protected Object validateAndParseParamValueString(final String paramValueStr, 
    final String name, final Object type, final Object rangeMin, final Object rangeMax) 
    throws Exception
  {
