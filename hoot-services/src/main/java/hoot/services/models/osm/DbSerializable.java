...
public interface DbSerializable
{
  ...
  //related records to this element (e.g. way nodes for ways, relation members for relations,
  //etc.)
  ...
  //field in the related record table that can be joined with the parent element record table
  NumberPath<Long> getRelatedRecordJoinField();

  //OSM related element type (e.g. way nodes for ways, relation members for relations) for the
  //wrapped record
