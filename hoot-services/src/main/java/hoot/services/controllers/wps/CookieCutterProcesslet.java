 ...
 *
 */
public class CookieCutterProcesslet extends JobProcesslet {
	private static final Logger log = LoggerFactory.getLogger(CookieCutterProcesslet.class);
	private String makefileName = null;
	
	public CookieCutterProcesslet() throws Exception
	{
		try {
    	makefileName = HootProperties.getProperty("CookieCutterMakefilePath");
