...
public class ExportOSMPBFCommand extends ExportCommand {

    ExportOSMPBFCommand(String jobId, Map<String, String> paramMap, String debugLevel, String outputType, String input, Class<?> caller) {
