...
public class MapQueryResponseWriter
{
   ...
   * @throws IOException
   */
  public Document writeResponse(final Map<ElementType, Map<Long, Tuple>> results,
    final BoundingBox queryBounds, final boolean multiLayerUniqueElementIds) throws Exception
  {
    ...
    catch (Exception e)
    {
      ResourceErrorHandler.handleError(
        "Error creating response for map query for map with ID: " + mapId + ". (" +
        e.getMessage() + ") ",
