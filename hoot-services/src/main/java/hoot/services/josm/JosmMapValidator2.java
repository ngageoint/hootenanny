 ...
 */
public class JosmMapValidator2
{
  public JosmMapValidator2(
...
////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //
  private JosmMapCleaner2 cleaner = null;
  ...
  private void parseValidationErrors(List<TestError> validationErrors, DataSet map) throws Exception
  {
    ...
    for (TestError error : validationErrors)
    {
      ...
      if (cleanValidated)
      {
        ...
        cleaner = new JosmMapCleaner2(addTags, elementErrorIndexes);
        cleaner.clean(error);
        deletedElementIds.addAll(cleaner.getDeletedElementIds());
      }
    }

    // Apparently, the clean fixes don't reflect any deleted elements. So, we'll manually delete
    // them here.
    removeDeletedElements(map, deletedElementIds);
  }

  private void removeDeletedElements(DataSet map, Set<String> deletedElementIds)
  {
