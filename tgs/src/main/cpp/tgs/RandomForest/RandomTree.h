...
namespace Tgs
{
  ...
  */
  ...
  public:
    ...
    */
    void buildTest(DataFrame & data, unsigned int numFactors);
    ...
    * @param data this data frame contains all the data vectors in the training set
    */
    double computeErrorRate(DataFrame & data);
    ...
    */
    void trainBinary(DataFrame & data, unsigned int numFactors, std::string posClass, 
    ...
    * @param balanced true if the tree should used balanced data
    */
    void trainMulticlass(DataFrame & data, unsigned int numFactors,
      unsigned int nodeSize = 1, bool balanced = false);
    ...
    * @param balanced true if the tree should used balanced data
    */
    void trainRoundRobin(DataFrame & data, unsigned int numFactors, std::string posClass, 
  ...
  private:
    ...
    */
    void _build(DataFrame & data, std::vector<unsigned int> & dataSet, TreeNode * node, unsigned int nodeSize);
    ...
    *  sum
    */
    void _calcFactorPurity(TreeNode * node, std::map<unsigned int, double> & factorPurity);
    ...
    * @param tabDepth set of tabs to indent the exported content
    */
    void _exportNode(std::ostream & fileStream, TreeNode * node, std::string tabDepth);
    ...
    * @param node the current node under consideration
    */
    void _importNode(std::istream & fileStream, TreeNode * node);
    ...
    */
    ...
    unsigned int _randSeedCtr;  ///Used to ensure different seeds for rand function

    TreeNode * _root; /// The root node for the tree
