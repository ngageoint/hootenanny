...
public:
   ...
   */
  static std::vector<std::map<std::string, std::pair<unsigned int, unsigned int>>>
    createDataSets(RandomForestInputs rfInputs, std::vector<double> splitPercentages);
   ...
   * @return the trained random forest model
   */
  static MultithreadedRandomForestManager generateMultithreadModel(RandomForestInputs & rfInputs, unsigned int numTrees,
                                                                   std::map<std::string, std::pair<unsigned int, unsigned int>> & trainingRangeMap);
