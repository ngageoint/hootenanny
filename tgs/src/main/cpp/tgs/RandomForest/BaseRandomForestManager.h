...
namespace Tgs
{
  ...
  public:
    ...
    */
    ...
    boost::shared_ptr<const DataFrame> getData() const { return _data; }
    ...
    */
    ...
    /**
     * Return a specific random forest.
     */
    boost::shared_ptr<BaseRandomForest> getForest(size_t i) { return _rfList[i]; }
