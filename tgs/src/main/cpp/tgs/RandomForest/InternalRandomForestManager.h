...
#ifndef __INTERNAL_RANDOM_FOREST_MANAGER_H__
#define __INTERNAL_RANDOM_FOREST_MANAGER_H__
...
namespace Tgs
{
  ...
  */
  ...
  public:
    ...
    *
    * @param fileStream the file stream to export the dataset
    * @param tabDepth set of tabs to indent the exported content
    */
    ...
    *  without file suffix
    */
    void generateUrgentReports(std::string basefilename);
    ...
    * @param basefilename the name of the output file without file suffix
    */
    void generateUrgentResults(std::string basefilename);
  ...
  private:
    ...
    * @param basefilename the name of the output file without file suffix
    */
    void _generateRemappedResults(std::string basefilename, std::map<std::string, std::vector<std::string> > & classMap);
    ...
    */
    ...
    std::vector<RandomForest> _rfList;  ///The base forest
