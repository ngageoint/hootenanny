...
//         cout << "  Comparing..." << endl;
        ...
        {
          //SpinImage testImage = stack.getImage(Tgs::Random::instance()->generateInt()() % stack.getSize());
          int randomIndex = Tgs::Random::instance()->generateInt()() % pc.getPoints().size();
  ...
  //           cout << " * comparing " << trainingType[trainingStackIdx];
            ...
            {
              int idx = Tgs::Random::instance()->generateInt()() % sig->getSize();
