...
public:
  ...
  void optimizationTest()
  {
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.136, uut.getSigma(), 0.001);
...
//    fs.close();
  ...
  void simpleTest()
  {
    ...
    uut.setSigma(0.002);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.3156, uut.estimateError(), 0.0001);
    uut.setSigma(0.008);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.091857, uut.estimateError(), 0.00001);
  }
