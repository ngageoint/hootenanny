...
public:
   ...
   */
  ScriptMatch(boost::shared_ptr<PluginContext> script, v8::Local<v8::Object> plugin,
  ...
  v8::Local<v8::Object> getPlugin(v8::Isolate* isolate) const { return _plugin.Get(isolate); }
