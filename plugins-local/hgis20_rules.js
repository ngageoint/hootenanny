...
hgis20.rules = {
    ...
    // TYPE is shared by a lot of features
     ...
     ['crime$TYPE','Drug Smuggling','raw:crimeTYPE','drug_smuggling'],
     ['crime$TYPE','Extortion','raw:crimeTYPE','extortion'],
     ['crime$TYPE','Fuel Smuggling','raw:crimeTYPE','fuel_smuggling'],
     ...
     ['health$TYPE2','Neonatal Tetanus','disease','neonatal_tetanus'],
     ['health$TYPE2','Parasitic Infectious Disease','disease','parasitic_infectious_disease'],
     ['health$TYPE2','Pertussis','disease','pertussis'],
     ['health$TYPE2','Polio','disease','polio'],
     ['health$TYPE2','Poliomyelitis','disease','poliomyelitis'],
     ['health$TYPE2','Rift Valley Fever','disease','rift_valley_fever'],
     ['health$TYPE2','Total Tetanus','disease','total tetanus'],
     ['health$TYPE2','Acute Jaundice Syndrome','disease','acute_jaundice_syndrome'],
     ['health$TYPE2','Acute Neurological Syndrome','disease','acute_neurological_syndrome'],
     ['health$TYPE2','Acute Respiratory Syndrome','disease','acute_respiratory_syndrome'],
     ['health$TYPE2','Acute Watery Diarrhoeal Syndrome','disease','acute_watery_diarrhoeal_syndrome'],
     ['health$TYPE2','Cerebro Spinal','disease','cerebro_spinal'],
     ['health$TYPE2','Lassa Fever','disease','lassa_fever'],
     ['health$TYPE2','Meningitis','disease','meningitis'],
     ['health$TYPE2','Meningococcal Disease','disease','meningococcal'],
     ['health$TYPE2','Yellow Fever','disease','yellow_fever'],
     ['health$TYPE2','999999','disease','999999'],
     ['health$TYPE2','Dengue','disease','dengue'],
     ['health$TYPE2','Equine Encephalitis','disease','equine_encephalitis'],
     ['health$TYPE2','Flu','disease','flu'],
     ['health$TYPE2','Hantavirus','disease','hantavirus'],
     ['health$TYPE2','Leptospirosis','disease','leptospirosis'],
