...
//      ['tourist$TYPE','Theater','raw:touristTYPE','theater'],
     ...
     ['transport$TYPE2','Station','transport:type2','station'],
     ['transport$TYPE2','Stop','transport:type2','stop'],
     ['transport$TYPE2','Terminal','transport:type2','terminal'],
     ['transport$TYPE2','Tunnel','transport:type2','tunnel'],
     ['transport$TYPE2','Yard','transport:type2','yard'],
