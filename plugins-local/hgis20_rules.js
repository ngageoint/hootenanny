...
//      ['hydrol$TYPE','Land Subject to Inundation','raw:hydrolTYPE','land subject to inundation'],
     ...
     ['military$TYPE2','Administrative Offices','military','administrative_offices'],
     ['military$TYPE2','Air Force Academy','military','air_force_academy'],
     ['military$TYPE2','Aircraft','military','aircraft'],
     ['military$TYPE2','Aircraft Storage','military','aircraft_storage'],
     ['military$TYPE2','Airfield','military','airfield'],
     ['military$TYPE2','Analytical Laboratory','military','analytical_laboratory'],
     ['military$TYPE2','Anti-Aircraft Site','military','anti-aircraft_site'],
     ['military$TYPE2','Anti-Ship Site','military','anti-ship_site'],
     ['military$TYPE2','Anti-Tank Site','military','anti-tank_site'],
     ['military$TYPE2','Armistice Signing Hall','military','armistice_signing_hall'],
     ['military$TYPE2','Armistice Talks Hall','military','armistice_talks_hall'],
     ['military$TYPE2','Arsenal','military','arsenal'],
     ['military$TYPE2','Artillery','military','artillery'],
     ['military$TYPE2','Ballistic','military','ballistic'],
     ['military$TYPE2','Barracks','military','barracks'],
     ['military$TYPE2','Base','military','base'],
     ['military$TYPE2','Border Control','military','border_control'],
     ['military$TYPE2','Building','military','building'],
     ['military$TYPE2','Bunker','military','bunker'],
     ['military$TYPE2','Camp','military','camp'],
     ['military$TYPE2','Checkpoint','military','checkpoint'],
     ['military$TYPE2','Coastal Battery Positions','military','coastal_battery_positions'],
     ['military$TYPE2','Command Facility','military','command_facility'],
     ['military$TYPE2','Communications and Electronics Site','military','communications_and_electronics_site'],
     ['military$TYPE2','Compound','military','compound'],
     ['military$TYPE2','Defensive River Obstacles','military','defensive_river_obstacles'],
     ['military$TYPE2','Detention Center','military','detention_center'],
     ['military$TYPE2','Dock Facility','military','dock_facility'],
     ['military$TYPE2','Entrance','military','entrance'],
     ['military$TYPE2','Facility','military','facility'],
     ['military$TYPE2','Factory','military','factory'],
     ['military$TYPE2','Firebase','military','firebase'],
     ['military$TYPE2','Firing Position','military','firing_position'],
     ['military$TYPE2','Fortified Position','military','fortified_position'],
     ['military$TYPE2','Fortress','military','fortress'],
     ['military$TYPE2','Garrison','military','garrison'],
     ['military$TYPE2','Gate','military','gate'],
     ['military$TYPE2','Gatehouse','military','gatehouse'],
     ['military$TYPE2','Gateway','military','gateway'],
     ['military$TYPE2','Guard Post','military','guard_post'],
     ['military$TYPE2','Hangar','military','hangar'],
     ['military$TYPE2','Headquarters','military','headquarters'],
     ['military$TYPE2','Helipad','military','helipad'],
     ['military$TYPE2','Installation','military','installation'],
     ['military$TYPE2','Joint Security Area','military','joint_security_area'],
     ['military$TYPE2','Launch Site','military','launch_site'],
     ['military$TYPE2','Main Building Guards','military','main_building_guards'],
     ['military$TYPE2','Mortar Pits','military','mortar_pits'],
     ['military$TYPE2','Motor Pool','military','motor_pool'],
     ['military$TYPE2','Mound','military','mound'],
     ['military$TYPE2','Nuclear Site','military','nuclear_site'],
     ['military$TYPE2','Observation Point','military','observation_point'],
     ['military$TYPE2','Obstructions','military','obstructions'],
     ['military$TYPE2','Open Shelter','military','open_shelter'],
     ['military$TYPE2','Outpost','military','outpost'],
     ['military$TYPE2','PTG','military','ptg'],
     ['military$TYPE2','Parade Reviewing Stand','military','parade_reviewing_stand'],
     ['military$TYPE2','Peace House','military','peace_house'],
     ['military$TYPE2','Post','military','post'],
     ['military$TYPE2','Psychological Warfare Liaison Office','military','psychological_warfare_liaison_office'],
     ['military$TYPE2','Rail Cargo Facility','military','rail_cargo_facility'],
     ['military$TYPE2','Reconnaissance Bureau','military','reconnaissance_bureau'],
     ['military$TYPE2','Recreation Facility','military','recreation_facility'],
     ['military$TYPE2','Research And Housing','military','research_and_housing'],
     ['military$TYPE2','Revetment','military','revetment'],
     ['military$TYPE2','Revolutionary Site','military','revolutionary_site'],
     ['military$TYPE2','Security','military','security'],
     ['military$TYPE2','Shed','military','shed'],
     ['military$TYPE2','Shelters','military','shelters'],
     ['military$TYPE2','Site','military','site'],
     ['military$TYPE2','Storage Facility','military','storage_facility'],
     ['military$TYPE2','Submarine Pen','military','submarine_pen'],
     ['military$TYPE2','Submerged Facility','military','submerged_facility'],
     ['military$TYPE2','Support Facilities','military','support_facilities'],
     ['military$TYPE2','Test Site','military','test_site'],
     ['military$TYPE2','Training Site','military','training_site'],
     ['military$TYPE2','Trench','military','trench'],
     ['military$TYPE2','Tunnel','military','tunnel'],
     ['military$TYPE2','Underground Facility','military','underground_facility'],
     ['military$TYPE2','Unit','military','unit'],
     ['military$TYPE2','Vehicle Positions','military','vehicle_positions'],
     ['military$TYPE2','Vehicles','military','vehicles'],
     ['military$TYPE2','Visitor Center and Gift Shop','military','visitor_center_and_gift_shop'],

     ['natural$TYPE','Arch','raw:naturalType','arch'],
     ['natural$TYPE','Bay','raw:naturalType','bay'],
     ['natural$TYPE','Beach','raw:naturalType','beach'],
     ['natural$TYPE','Cape','raw:naturalType','cape'],
     ['natural$TYPE','Cave','raw:naturalType','cave'],
     ['natural$TYPE','Cliff','raw:naturalType','cliff'],
     ['natural$TYPE','Cove','raw:naturalType','cove'],
     ['natural$TYPE','Depression','raw:naturalType','depression'],
     ['natural$TYPE','Desert','natural','desert'],
     ['natural$TYPE','Dike','raw:naturalType','dike'],
     ['natural$TYPE','Dune','raw:naturalType','dune'],
     ['natural$TYPE','Escarpment','raw:naturalType','escarpment'],
     ['natural$TYPE','Ford','raw:naturalType','ford'],
     ['natural$TYPE','Forest','raw:naturalType','forest'],
     ['natural$TYPE','Gorge','natural','gorge'],
     ['natural$TYPE','Hammock','raw:naturalType','hammock'],
     ['natural$TYPE','Hill','raw:naturalType','hill'],
     ['natural$TYPE','Island','raw:naturalType','island'],
     ['natural$TYPE','Lagoon','raw:naturalType','lagoon'], // ARRRGGH!
     ['natural$TYPE','Landmark','raw:naturalTYPE','landmark'],
     ['natural$TYPE','Mesa','raw:naturalType','mesa'],
     ['natural$TYPE','Mountain','natural','mountain'],
     ['natural$TYPE','Mud Flats','raw:naturalType','mud_flats'],
     ['natural$TYPE','Oasis','raw:naturalType','oasis'],
     ['natural$TYPE','Other','waterway','other'],
     ['natural$TYPE','Pass','raw:naturalType','pass'],
     ['natural$TYPE','Peak','natural','peak'],
     ['natural$TYPE','Plain','raw:naturalType','plain'],
     ['natural$TYPE','Plateau','raw:naturalType','plateau'],
     ['natural$TYPE','Point','raw:naturalType','point'],
     ['natural$TYPE','Ponds','water','pond'],
     ['natural$TYPE','Preserve/Refuge','raw:naturalTYPE','preserve/refuge'],
     ['natural$TYPE','Reef','raw:naturalType','reef'],
     ['natural$TYPE','Ridge','raw:naturalType','ridge'],
     ['natural$TYPE','Rock','raw:naturalType','rock'],
     ['natural$TYPE','Salt Area','raw:naturalType','salt_area'],
     ['natural$TYPE','Sinkhole','raw:naturalType','sinkhole'],
     ['natural$TYPE','Springs','raw:naturalType','springs'],
     ['natural$TYPE','Spur','raw:naturalType','spur'],
     ['natural$TYPE','Valley','raw:naturalType','valley'],
     ['natural$TYPE','Volcano','natural','volcano'],
     ['natural$TYPE','Wadi','raw:naturalType','wadi'],
...
//      ['railwayp$TYPE1','Passenger','railway:type','passenger'],
     ...
     ['UNITS','Kilograms per year','raw:units','Kilograms per year'],
     ['UNITS','Metric tons per year','raw:units','Metric tons per year'],
     ['UNITS','Thousand metric tons per year','raw:units','Thousand metric tons per year'],
