...
hgis20.rules = {
    ...
    layerOut : [
     ...
     ['XtableName','Airfields','XXX','XXX'],
     ['XtableName','Border_Crossings','XXX','XXX'],
     ...
     ['XtableName','Internet_Cafes','XXX','XXX'],
     ['XtableName','Languages','XXX','XXX'],
     ['XtableName','Libraries','XXX','XXX'],
     ...
     ['XtableName','Military_Installations','XXX','XXX'],
     ['XtableName','Natural_POI','XXX','XXX'],
     ['XtableName','Natural_Resources','XXX','XXX'],
     ['XtableName','Ports','XXX','XXX'],
     ['XtableName','Power_Plants','XXX','XXX'],
     ['XtableName','Prisons','XXX','XXX'],
...
//      ['SPA_ACC','5 - Country','hgis:accuracy','country'],
   ...
   // We use this for assigning a short name and validation
    layerNames : {
     ...
     // Feature Dataset groupings
   // Lookup table for layernames.
   // We use this for assigning a short name and validation
    thematicGroup : {
     'ADMIN0':'Administrative',
     'Admin0_Access_To_Services':'Demographics',
     'Admin0_Education':'Demographics',
     'Admin0_Employment':'Demographics',
     'Admin0_Household_Goods':'Demographics',
     'Admin0_Mortality':'Demographics',
     'Admin0_Population':'Demographics',
     'Admin0_Poverty':'Demographics',
     'ADMIN1':'Administrative',
     'Admin1_Access_To_Services':'Demographics',
     'Admin1_Education':'Demographics',
     'Admin1_Employment':'Demographics',
     'Admin1_Household_Goods':'Demographics',
     'Admin1_Mortality':'Demographics',
     'Admin1_Population':'Demographics',
     'Admin1_Poverty':'Demographics',
     'ADMIN2':'Administrative',
     'Admin2_Access_To_Services':'Demographics',
     'Admin2_Education':'Demographics',
     'Admin2_Employment':'Demographics',
     'Admin2_Household_Goods':'Demographics',
     'Admin2_Mortality':'Demographics',
     'Admin2_Population':'Demographics',
     'Admin2_Poverty':'Demographics',
     'ADMIN3':'Administrative',
     'ADMIN4':'Administrative',
     'ADMIN5':'Administrative',
     'Agricultural_POI':'Economy',
     'Airfields':'Critical_Infrastructure',
     'Border_Crossings':'Government_Municipal',
     'Bridges_Tunnels':'Critical_Infrastructure',
     'Commercial_POI':'Economy',
     'Conflict_Points':'Significant_Events',
     'Crime_Data':'Crime_Public_Security',
     'Cultural_POI':'Culture_Ethnicity',
     'Dams':'Critical_Infrastructure',
     'Educational_Institutions':'Education',
     'Electrical_POI':'Critical_Infrastructure',
     'Embassies':'Government_Municipal',
     'Ethnicity':'Culture_Ethnicity',
     'Foreign_Investment_Projects':'Economy',
     'Free_Trade_Zones':'Economy',
     'Free_Trade_Zones_Polygons':'Economy',
     'Geonames':'Administrative',
     'GNDB':'Administrative',
     'Government_POI':'Government_Municipal',
     'HADR':'Significant_Events',
     'Health_Events':'Medical_Health',
     'Hydrology_POI':'Critical_Infrastructure',
     'Hydrology_Polygons':'Hydrology',
     'Hydrology_Polylines':'Hydrology',
     'Internet_Cafes':'Communication',
     'Languages':'Culture_Ethnicity',
     'Libraries':'Education',
     'Lodging_POI':'Economy',
     'Marine_POI':'Critical_Infrastructure',
     'Media_Outlets':'Communication',
     'Medical_Facilities':'Medical_Health',
     'Military_Installations':'Government_Municipal',
     'Natural_POI':'Natural_Features',
     'Natural_Resources':'Natural_Features',
     'Ports':'Critical_Infrastructure',
     'Power_Plants':'Critical_Infrastructure',
     'Prisons':'Crime_Public_Security',
     'Protected_Areas':'Environmental_Regulatory',
     'Public_Security_POI':'Crime_Public_Security',
     'Public_Transportation_POI':'Critical_Infrastructure',
     'Railways':'Critical_Infrastructure',
     'Railways_POI':'Critical_Infrastructure',
     'Recreation_POI':'Economy',
     'Refugee_Camps':'Government_Municipal',
     'Religion':'Religion',
     'Religious_Institutions':'Religion',
     'Roads':'Critical_Infrastructure',
     'Smuggling_Routes':'Crime_Public_Security',
     'Smuggling_Routes_Polyline':'Crime_Public_Security',
     'Soils':'Natural_Features',
     'Tourist_Locations_POI':'Economy'
     }, // End thematicGroup
