...
exports.mergeSets = function(map, pairs, replaced)
{
  if (!mergeOptionsConfigured)
  {
    ...
    // this logic for other matchers going forward or maybe MultilineStringMergeRelationCollapser
    // should be made part of LinearSnapMerger?. This has to be done within this method, b/c its
