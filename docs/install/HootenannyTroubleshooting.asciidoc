...
settings used in the InstallHoot.sh script):
...
To re-create the hoot database, run the InstallHoot.sh script with only the +UPDATE_DATABASE+ variable set to "true".
