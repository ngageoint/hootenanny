...
The recommended and easiest installation method is to install from RPMs.  This can be accomplished by the performing following steps:

1. Create the following file: +/etc/yum.repos.d/hoot.repo+
