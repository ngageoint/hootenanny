...
The --ogr sub-option must be used in conjunction with either or both of the --input and --output sub-options. Other sub-options are ignored
when used in conjunction with --ogr.
