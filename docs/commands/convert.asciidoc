...
If a configuration option matching, `convert.bounds.*` is set to a valid bounding box, supporting readers will read data only from
...
--------------------------------------
hoot convert -D convert.bounds=2.277303,48.851684,2.311635,48.864701 https://osm-api-url/api/0.6/map download.osm
--------------------------------------
