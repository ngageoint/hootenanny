...
* +--strict-bounds+              - Determines how strict the interpretation of the specified bounds is during feature replacement. Precludes 
                                   ...
                                   completely replaced, but they may be modified. With this option omitted, features overlapping the bounds may 
                                   be completely replaced. See the  "Bounds Handling" section for more detail.
* +--hybrid-bounds+              - Determines how strict the interpretation of the specified bounds is during feature replacement. Precludes 
                                   ...
                                   and the lenient bounds interpretation for polygon features. See the "Bounds Handling" section for more detail.
