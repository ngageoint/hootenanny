...
should be filtered from the data set. When +ogr2osm+ is launched Hootenanny
...
--------------------------------------
hoot ogr2osm MyGdbTranslation MyGdbOutput.osm MyGdb.gdb;ROAD_L \
...
--------------------------------------
hoot ogr2osm $HOOT_HOME/translations/TDSv40.js tds_roads.osm \
