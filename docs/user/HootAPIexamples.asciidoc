...
------
hoot convert -D hootapi.db.writer.create.user=true -D hootapi.db.writer.email='test@test.com' test-files/DcGisRoads.osm  hootapidb://hoot:hoottest@localhost:5432/hoot/DcGISRoads2
------

* +-D hootapi.db.writer.create.user+ - a required parameter when using instantiating a new user from the hoot.json file.
* +-D hootapi.db.writer.email+ - a required email notification parameter for the hoot.json file.  The value should appear in +hoot.json+ with a placeholder email address.
...
------
hoot conflate -D hootapi.db.reader.email='test@test.com' -D hootapi.db.writer.email='test@test.com' hootapidb://hoot:hoottest@localhost:5432/hoot/DcGisRoads hootapidb://hoot:hoottest@localhost:5432/hoot/DcTigerRoads  hootapidb://hoot:hoottest@localhost:5432/hoot/Merged_Roads_test
------

* +-D hootapi.db.reader.email+ - required email notification parameters for the hoot.json file.  The value should appear in +hoot.json+ with a placeholder email address.
* +-D hootapi.db.writer.email+ - required email notification parameters for the hoot.json file.  The value should appear in +hoot.json+ with a placeholder email address.
...
------
hoot osm2shp -D hootapi.db.reader.email='test@test.com' translations/OSM_Ingest.js hootapidb://hoot:hoottest@localhost:5432/hoot/DcGisRoads tmp/DGRoads.shp
------
...
------
hoot osm2ogr -D hootapi.db.reader.email='test@test.com' translations/MGCP_TRD4.js hootapidb://hoot:hoottest@localhost:5432/hoot/DcGisRoads tmp/DGRoads.gdb
------
...
e.g. hoot crop-map hootapidb://hoot:hoottest@localhost:5432/hoot/DcGisRoads "-77.0551,38.8845,-77.0281,38.9031"
------
...
------
hoot stats -D hootapi.db.reader.email='test@test.com' hootapidb://hoot:hoottest@localhost:5432/hoot/DcGisRoads
------
