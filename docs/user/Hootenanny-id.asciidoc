...
API database which has limited utility outside of application testing.  For details on how to configure Hootenanny to conflate you OSM API 
database data, have you system administrator follow the instructions in the  the "Configuring OSM API Database Conflation" section of the 
Hootenanny Installation Guide.
...
Hootenanny will export an OSM changeset with the geospatial bounds of the original conflation job that is the difference between the data 
originally exported from the OSM API database for conflation and the resulting conflated data.  
