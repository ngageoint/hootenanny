...
conflate features, it will mark one or more features as needing a manual review by the user.

.*Linear Feature Review Situations*
[width="100%"]
|======
...
TODO: add review descriptions for other features types
