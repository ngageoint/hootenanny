...
Hootenanny conflates POIs with both building and area polygons.  See <<hootalgo, Hootenanny - Algorithms>>, POI to Polygon Conflation section for specific algorithm details and configuration options.
