...
Use the value +OverwriteTag2Merger+ . For example:

------
hoot conflate -D tag.merger.default=OverwriteTag2Merger input1.osm input2.osm output.osm
------
...
Use the value +AverageTagMerger+ . For example:

------
hoot conflate -D tag.merger.default=AverageTagMerger input1.osm input2.osm output.osm
------
...
Use the value +GeneralizeTagMerger+ . For example:

------
hoot conflate -D tag.merger.default=GeneralizeTagMerger input1.osm input2.osm output.osm
------
...
Use the value +ProvenanceAwareOverwriteTagMerger+ . For example:

------
hoot conflate -D tag.merger.default=ProvenanceAwareOverwriteTagMerger input1.osm input2.osm output.osm
------
...
Use the value +PreserveTypesTagMerger+ . For example:

------
hoot conflate -D tag.merger.default=PreserveTypesTagMerger input1.osm input2.osm output.osm
------
