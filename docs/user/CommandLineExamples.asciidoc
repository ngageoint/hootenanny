...
==== Run validation on a map and mark failing features:
...
-----
    hoot validate /my/dir output.osm --recursive "*"
-----

==== Run validation on map data map data recursively across multiple OSM files under a directory:

-----
    hoot validate /my/dir output.osm --recursive "*.osm"
-----
