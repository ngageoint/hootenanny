...
(Please note, source and error tags are treated as a special case and cannot be removed by RemoveTagsVisitor. Use options writer.include.circular.error.tags=false and reader.add.source.datetime=false)
-----
