...
===== Replace all features in a first dataset with overlapping features from the second dataset within a specified bounds:
...
===== Replace all buildings in a first dataset with overlapping buildings from the second dataset within a specified bounds:
...
===== Replace all POIs in a first dataset with overlapping schools from a second dataset within a specified bounds:
-----
