...
See the User Guide for more specific details on command usage. Most of these examples use .osm files, however, many [other formats](https://github.com/ngageoint/hootenanny/blob/master/docs/user/SupportedDataFormats.asciidoc) are supported.
...
* [Alignment](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#alignment)
* [Applying Changes](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#applying-changes)
* [Cleaning](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#cleaning)
* [Comparison](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#comparison)
* [Conflation](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#conflation)
* [Conversion](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#conversion)
* [Language Translation](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#language-translation)
* [MetaInfo](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#metainfo)
* [Schema Translation](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#schema-translation)
* [Statistics](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#statistics)
* [Tag Info](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#tag-info)
* [Tag Manipulation](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#tag-manipulation)
* [Utilities](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#utilities))
* [Validation](https://github.com/ngageoint/hootenanny/blob/master/docs/user/CommandLineExamples.asciidoc#validation)
...
-----
hoot stat -D nodes.per.way.visitor.element.criterion=hoot::BuildingCriterion input.osm \
  hoot::NodesPerWayVisitor average
-----
...
==== Display a all tag keys in a map as a delimited list string:
