...
===== Count the number of elements with a version greater than or equal to one TODO:

-----
    hoot count input.osm hoot::AttributeValueCriterion
-----

===== Count the number of elements authored by "username" TODO:
