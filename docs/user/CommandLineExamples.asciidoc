...
-----
    ...
    hoot conflate -D convert.bounds="-71.4698,42.4866,-71.4657,42.4902" input1.osm input2.osm output.osm

    # non-rectangular polygon bounds
    hoot conflate -D convert.bounds="-71.4745,42.4841;-71.4669,42.4918;-71.4619,42.4839;-71.4745,42.4841" input1.osm \ 
...
===== Create a changeset that completely replaces features with those from another dataset within a specified bounding box:
...
-----
    hoot changeset-derive-replacement -D changeset.user.id=1 input1.osm input2.osm \
      "-71.4745,42.4841;-71.4669,42.4918;-71.4619,42.4839;-71.4745,42.4841" output.osc
-----

===== Create a changeset that removes all features within a specified bounding box:

-----
    hoot changeset-derive-replacement -D changeset.user.id=1 input.osm "-71.4698,42.4866,-71.4657,42.4902" \
      output.osc
-----

===== Create a changeset that completely replaces all buildings with those from another dataset within a specified bounding box:
...
-----
    hoot convert -D convert.bounds="-71.4698,42.4866,-71.4657,42.4902" input1.osm input2.osm output.osm
-----

===== Combine multiple OSM files into a single file within a polygon area:

-----
    hoot convert -D convert.bounds="-71.4745,42.4841;-71.4669,42.4918;-71.4619,42.4839;-71.4745,42.4841" \
      input1.osm input2.osm output.osm
-----
...
===== Create a changeset that replaces all buildings and POIs in a dataset with buildings and POIs from another dataset within a specified bounds:
...
===== Create a changeset that replaces all POIs in a dataset with cafes having "Java" in the name from another dataset within a specified bounds:
