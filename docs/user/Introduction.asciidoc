...
To use, pass +ReferenceConflation.asciidoc+ to the conflate command.  

e.g. 'hoot conflate -C ReferenceConflation.conf input1.osm input2.osm output.osm
...
To use, pass +HorizontalConflation.asciidoc+ to the conflate command.  

e.g. 'hoot conflate -C HorizontalConflation.conf input1.osm input2.osm output.osm
...
To use, pass +DifferentialConflation.asciidoc+ to the conflate command.  

e.g. 'hoot conflate -C DifferentialConflation.conf input1.osm input2.osm output.osm

More details: <<hootalgo, DifferentialConflation>>

===== Attribute Conflation

To use, pass +AttributeConflation.asciidoc+ to the conflate command.  

e.g. 'hoot conflate -C AttributeConflation.conf input1.osm input2.osm output.osm
