...
* Completely [replace](https://github.com/ngageoint/hootenanny/blob/master/test-files/cmd/glacial/serial/ServiceBuildingReplacementTest.sh) features in an OpenStreetMap data store by AOI with features from another map
