...
for the Hootenanny Core code or you will get inaccurate results.  The Java Web Services'make services-coverage' command doesn't actually require 'make test' to be run 
