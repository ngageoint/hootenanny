...
----------------
./configure --with-rnd --with-josm --with-services --with-coverage && make clean-coverage && make -j$(nproc) && make -j$(nproc) && HootTest --glacial --parallel && make -j$(nproc) coverage
----------------
