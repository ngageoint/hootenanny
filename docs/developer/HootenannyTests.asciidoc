...
===== Running Only Tests Which Use Validation
...
===== Switching JOSM Implementations

There may be a need to run the tests against a different JOSM implementation than specified in the
default configuration. To do this, see the "JOSM Configuration" section under the 
"Using Validation Checks to Improve Conflated Maps" section in the Developer Documentation.
