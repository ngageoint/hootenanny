...
Hoot Services (hoot-services) - Web services that expose OSM data editing, core Hootenanny functionality via REST, and Hootenanny data via WFS
...
<<<<<<< HEAD
* hoot-services should start and load all the Jersey services.  If you see class not found errors, your Tomcat debug environment probably is not set up properly...see the troubleshooting guide.
=======
...
>>>>>>> a89c9628b4ee98650a9ab80a8c9b5126ce872959
