...
---------------------------
hoot implicit-type-tagging-rules --create-raw "planet.osm.pbf;allCountries.geonames" "none;translations/GeoNames.js" \
...
---------------------------
hoot implicit-type-tagging-rules --create-raw -D implicit.tagging.raw.rules.deriver.skip.filtering=true \
...
---------------------------
hoot implicit-type-tagging-rules --create-db osm-geonames-poi.implicitTagRules osm-geonames-poi-rules.sqlite
---------------------------------

You can check the results of a generated database with:

-------------------------
hoot implicit-type-tagging-rules --db-stats osm-geonames-poi.implicitTagRules
------------------------
