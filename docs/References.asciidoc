...
- [[[hootuser]]] "Hootenanny - Supplemental User Documentation"
...
- [[[hootInstall]]] "Hootenanny -Installation Guide": Provides installation instruction for CentOS/RHEL 6.5 for Hootenanny and its dependencies.
...
[[Conflation]]Conflation::
  ...
  as to retain accuracte data, minimize redundancy, and reconcile data 
  conflicts.
