...
* image:images/image036.png[] & image:images/image037.png[] - Standard deviation of the circular error of ways 1 & 2

* image:images/image038.png[] - Per the Abramowitz & Stegun (1964) approximation for calculating image:algorithms/images/image039.png[]

* image:images/image040.png[] - The mean distance between the ways
