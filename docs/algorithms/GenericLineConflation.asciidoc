...
[width="100%"]
|======
| *Test Number* | *AOI* | *Reference Data* | *Secondary Data* | *Manually Matched Feature Count* | *Percentage Correctly Conflated* | *Percentage Marked for Unecessary Review* | *Percentage Combined Correct and Reviewable* | *Time Elapsed (MM:SS)*
| 1 | Mozambique | ENERGYDATA.INFO | OpenStreetMap | 62 | 96.7 | 0.0 | 96.7 | 05:14
| 2 | Namibia | ENERGYDATA.INFO | OpenStreetMap | 200 | 51.7 | 0.0 | 51.7 | 23:15
| 3 | California Bay Area | California State Govt | OpenStreetMap | 229 | 75.3 | 0.0 | 75.3 | 01:39
| 4 | Los Angeles | California State Govt | OpenStreetMap | 204 | 69.6 | 1.2 | 70.8 | 00:56
| 5 | Namibia | MGCP | ENERGYDATA.INFO | 41 | 71.7 | 0.0 | 71.7 | 00:30 
| 6 | Namibia | ENERGYDATA.INFO | OpenStreetMap | 51 | 92.7 | 0.0 | 92.7 | 03:53 
|======
...
It is worth noting that some of the ENERGYDATA.INFO and MGCP data contain previously added OpenStreetMap data.  Therefore, in some cases 
