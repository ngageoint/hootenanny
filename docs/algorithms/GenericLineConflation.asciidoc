...
| rubber sheeting input data | no | move secondary data toward reference data using rubber sheeting before conflation
...
Rubber sheeting resulted in runtime exceptions for some of the input data.  The cause for this wasn't immediately obvious, so the issue 
...
individual cable as a separate way.  The desired outcome when conflating these two types of data would be to generate a review for user to decide
which way they want to represent the features.  However, that proved difficult to implement in Hootenanny for this situation and needs
improvement.
...
[width="100%"]
|======
| *Test Number* | *AOI* | *Reference Data* | *Secondary Data* | *Manually Matched Feature Count* | *Percentage Correctly Conflated* | *Percentage Marked for Unecessary Review* | *Percentage Combined Correct and Reviewable* | *Time Elapsed (HH:MM:SS)*
| 1 | Mozambique | ENERGYDATA.INFO | OpenStreetMap | 62 | 96.7 | 0.0 | 96.7 | 00:05:14
| 2 | Namibia | ENERGYDATA.INFO | OpenStreetMap | 200 | 51.7 | 0.0 | 51.7 | 00:00:00
| 3 | California Bay Area | California State Govt | OpenStreetMap | 229 | 75.3 | 0.0 | 75.3 | 00:01:39
| 4 | Los Angeles | California State Govt | OpenStreetMap | 204 | 69.6 | 1.2 | 70.8 | 00:00:00
| 5 | Namibia | MGCP | ENERGYDATA.INFO | 41 | 71.7 | 0.0 | 71.7 | 00:00:30 
| 6 | Namibia | ENERGYDATA.INFO | OpenStreetMap | 51 | 92.7 | 0.0 | 92.7 | 00:03:53 
|======

The 80% correct conflation threshold was met by two of the tests, with three additional tests rougly at or better than 70% correct.  The Nambia test with only 51.7% correct obviously still requires attention, though.
