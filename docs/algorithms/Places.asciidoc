...
data types, Hootenanny supports an error:circular column that specifies the
...
hoot convert -D "convert.ops=hoot::SchemaTranslationVisitor" -D schema.translation.script=$HOOT_HOME/translations/GeoNamesOrg.js allCountries.geonames allCountries.osm.pbf
-------
