...
hoot convert -D "convert.ops=hoot::TranslationOp" -D schema.translation.script=$HOOT_HOME/translations/GeoNamesOrg.js allCountries.geonames allCountries.osm.pbf
-------
