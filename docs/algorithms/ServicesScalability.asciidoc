...
If files of this size are of interest, the best approach would be to use Hadoop to
process the data across a large number of machines. Unfortunately, Hadoop development 
within Hootenanny is not receiving active development at this time.
