 ...
 *
 * @copyright Copyright (C) 2013, 2014, 2019 DigitalGlobe (http://www.digitalglobe.com/)
 */

//
// MGCP Conversion for Cartographic Rendering
//
// NOTE: This is identical to the standard MGCP_TRD4 translation. We need it named differently so that the Hoot Services
// can identify that it is different and add different options to the export command.
//
// I.e.  hoot convert  \
//        -D convert.ops=hoot::GeometryModifierOp  \
//        -D geometry.modifier.rules.file=$HOOT_HOME/translations/mgcpCartoMod.json \
//        <INPUT OSM FILE> \
//        <OUTPUT MGCP SHP|FGDB> \
//        --trans $HOOT_HOME/translations/MGCP_TRD4.js 
//
