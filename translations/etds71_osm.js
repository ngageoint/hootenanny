...
/*
    ...
    This script is the same as the standard "etds_osm" script but uses "tds71" instead of "tds"
*/
...
etds71_osm = {
    ...
    toOSM : function(attrs, elementType, geometryType)
    {
        ...
        translate.applyOne2One(attrs, nAttrs, etds71_osm_rules.enumValues, {'k':'v'},[]);
        var tags = {};

        // Now convert the attributes to tags.
        tags = tds71.toOsm(nAttrs,'',geometryType);
        ...
        if (fCode2 !== '')
        {
            var ftag = tds71.fcodeLookup['F_CODE'][fCode2];
            if (ftag)
            {
                if (!(tags[ftag[0]]))
                {
...
if (typeof exports !== 'undefined') {
    exports.toOSM = etds71_osm.toOSM;
    exports.EnglishtoOSM = etds71_osm.toOSM;
    exports.RawtoOSM = tds71.toOsm;
    exports.OSMtoEnglish = etds71.toEnglish;
    exports.OSMtoRaw = tds71.toOgr;
}
