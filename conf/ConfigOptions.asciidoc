...
If true, then features with a common type ancestor in their tag data will be more likely to match
during POI to polygon matching.
...
If true, then custom schema mods are used in POI to polygon matching.  TODO: This setting will
not be a permanent config option.
