...
Count at which the load status of each element type should be logged.  e.g. With a value of 10000,
you will see a element load status update message for every 10000 elements parsed.
