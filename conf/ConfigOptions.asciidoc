...
an exact match based on distance criteria only.
...
This will generally generate more reviews when turned on than when turned off.  TODO: This setting
may not be needed after poi-polygon conflation moves beyond a prototype.
...
* Data Type: string
* Default Value: `hoot::SuperfluousNodeRemover;hoot::SmallWayMerger;hoot::RemoveEmptyReviewRelationsVisitor`
