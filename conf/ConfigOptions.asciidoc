...
=== changeset.sql.use.internal.ids

* Data Type: bool
* Default Value: `false`

This forces the SQL changeset writer to ignore element ID sequences in the target OSM API database.  Enable for testing purposes only.
