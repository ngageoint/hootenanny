...
If true, the PBF data reader will deliver data to consumers in type-then-id order (i.e., all nodes in
increasing ID number order, followed by all ways in increasing ID order and finally all relations in
increasing ID order).
...
* Data Type: string
* Default Value: `postgresql://vagrant:vagrant@localhost:15432/openstreetmap`
