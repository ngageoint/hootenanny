...
Determines whether the conflate command will use the element ID's specified by the input dataset (true) or use internal ID management for the first conflation input.
