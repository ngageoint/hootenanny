...
* Data Type: string
* Default Value: `hoot::BuildingMatchCreator;hoot::PlacesPoiMatchCreator;hoot::HighwayMatchCreator;hoot::PoiPolygonMatchCreator;hoot::ScriptMatchCreator,Area.js`
...
* `hoot::ScriptMatchCreator,PoiGeneric.js` - Matches POIs using the Unify
  algorithm.
* `hoot::ScriptMatchCreator,Area.js` - Matches non-building polygon areas.
...
If false, POI to polygon conflation will not take address tags into account.  Disable this to
boost runtime performance if your data has little or no address information or you know the address
