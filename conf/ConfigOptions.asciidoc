...
* Data Type: string
* Default Value: `hoot::BuildingMergerCreator;hoot::PlacesPoiMergerCreator;hoot::HighwaySnapMergerCreator;hoot::PoiPolygonMergerCreator;hoot::ScriptMergerCreator`
...
=== poi.polygon.enable.match.rules

* Data Type: bool
* Default Value: `true`

If false, POI to polygon conflation will not execute custom matching rules and will only use the
simpler, evidence based additive model for determining matches.  Disable this setting to boost
runtime performance if your data is not covered by any of the rules.  See PoiPolygonMatchRules for
more details.  This setting will likely be removed in the future.
