...
network conflation. A value of 1 will give approx (1 / n * score * weight) influence to each neighbor.
...
using network conflation.  Higher values will reduce that contribution. Reasonable range is [0, ~10].
