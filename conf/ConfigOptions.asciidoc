...
If true, any element with a value populated for the key defined by set.tag.visitor.key will have
the value specified in set.tag.visitor.value appended to it.
