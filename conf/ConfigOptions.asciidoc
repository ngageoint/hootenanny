...
* Data Type: string
* Default Value: `hoot::BuildingMatchCreator;hoot::PlacesPoiMatchCreator;hoot::HighwayMatchCreator;hoot::PoiPolygonMatchCreator`
...
* `hoot::HighwayMatchCreator` - Matches linear highway features using the Unify
  algorithm.
* `hoot::PoiPolygonMatchCreator` - Matches POI's and buldings the Unify algorithm.
...
* Data Type: string
* Default Value: `hoot::BuildingMergerCreator;hoot::PlacesPoiMergerCreator;hoot::HighwaySnapMergerCreator;hoot::PoiPolygonMergerCreator`
...
If false, POI to polygon conflation will not take address tags into account.  Disable this if your
data has no address information or you know the information to be inaccurate.
...
=== poi.polygon.reduce.reviews

* Data Type: bool
* Default Value: `true`

If true, POI to polygon conflation will attempt to reduce unnecessary reviews by applying a custom
rule set.  If you find reducing the reviews with this setting leads to poor conflation results,
disable this setting.  This setting is likely temporary and will be removed in the future after
more POI to polygon conflation testing has occurred.
