...
TODO: Update conflator min valid score
...
TODO: Get description of create bogus review tags
...
If set to 'true' then the ProbabilityMatch class will use a model for evaluating the probability of a match.

=== match.model.name

* Data Type: string
* Default Value: `dc-attributes`

The name of the model to use when classifying a pair of ways as a match or miss.

Some of the possible options includ:
* `dc-noattributes`
* `dc-attr-intersection`
...
TODO: Explain create all layers
...
TODO: Explain ogr writer script key
...
TODO: Description for perty.duplicate.poi.duplicate.sigma
...
TODO: Description for perty.duplicate.poi.move.multiplier
...
TODO: Description for perty.duplicate.poi.p
...
TODO: Description for perty.name.p
...
TODO: Description for perty.name.change.p
...
TODO: Definition for perty.remove.random.p
...
TODO: Definition for perty.remove.tag.p
...
TODO: What is the distance weight?
...
TODO: What is the goodness threshold?
...
TODO: What is the minimum edit similarity?
...
TODO: What is the string weight?
...
=== services.db.reader.max.elements.per.partial.map
* Data Type: int
* Default Value: `50000`
...
=== services.db.writer.overwrite.map

* Data Type: bool
* Default Value: `false`

TODO: What does services.db.writer.overwrite.map do?
...
TODO: Description for way.splitter.max.length
