...
is not supported by all data readers.  See the documentation for details.

=== osm.api.convert.bounding.box

* Data Type: string
* Default Value: ``

Same as convert.bounding.box but the resultant bounds filtering is only applied to OSM API database
data sources.  This setting takes precendence over convert.bounding.box for OSM API database data
sources.

=== hoot.api.convert.bounding.box

* Data Type: string
* Default Value: ``

Same as convert.bounding.box but the resultant bounds filtering is only applied to Hootenanny API
database data sources.  This setting takes precendence over convert.bounding.box for Hootenanny API
...
List of element attributes to remove with the RemoveAttributeVisitor.
