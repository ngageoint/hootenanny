...
=== implicit.tagging.element.filter
...
ImplicitTagEligiblePoiPolyCriterion, derives tag information from POIs, buildings, and areas.
...
=== set.tag.value.visitor.filter

* Data Type: string
* Default Value: ``

The plugin name of a filter used to select elements to add or modify tags on.
