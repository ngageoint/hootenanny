...
E.g. Setting this to 'shp' would be telling the translation script to shorten attribute names to 10 characters, keep text
attributes below the 255 character maximum length and split tags in o2s_X files into 254 char chunks.
