...
=== poi.polygon.disable.intradataset.conflation

* Data Type: bool
* Default Value: `false`

Enabling this option prevents POIs and Polygons from within the same dataset to be matched. Enabling
it option causes poi.polygon.disable.same.source.conflation to be ignored.
