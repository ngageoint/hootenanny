...
Note: This value was found experimentally with the building data from #3446 and #3495 and validated
with JOSM validation. Further tweaks may be required to the default value for other datasets.
...
=== ogr2osm.simplify.ways.criterion

* Data Type: string
* Default Value: `hoot::BuildingCriterion`
