...
=== poi.implicit.tag.rules.cache.size

* Data Type: int
* Default Value: `1000000`

The maximum size of entries allowed in each POI implicit tag rules deriver cache data structure.

=== poi.implicit.tag.rules.database

* Data Type: string
* Default Value: `conf/dictionary/ImplicitTagRules.sqlite`
...
* Data Type: string
* Default Value: `conf/core/poiImplicitTagRulesTagIgnoreList`

Flat file containing key/value pairs, one per line, to ignore when deriving implicit tags from POI
names.

=== poi.implicit.tag.rules.run.in.memory

* Data Type: bool
* Default Value: `false`

If true, the POI implicit tag deriver will store all data in memory.  temp setting

=== poi.implicit.tag.rules.word.ignore.list

* Data Type: string
* Default Value: `conf/core/poiImplicitTagRulesWordIgnoreList`
