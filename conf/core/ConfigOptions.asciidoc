...
specified by +poi.match.distances.config+. Its JSON format matches that in the file referenced by
+poi.match.distances.config+.

=== poi.match.distances.config

* Data Type: string
* Default Value: `conf/core/PoiMatchDistances.json`

Points to a JSON file defining the default match/review distance configuration for POI to POI
Conflation. Use of this file is overridden when +poi.match.distances+ is specified.
