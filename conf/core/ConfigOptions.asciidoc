...
=== language.translation.hoot.services.endpoint

* Data Type: string
* Default Value: `http://localhost:8080/hoot-services/language/translateWithDetect`

Web service endpoint used by the HootServicesLanguageDetector

=== language.translation.hoot.services.translator.detectors
...
Language detectors used during to English language translation in order of entry by
HootServicesTranslator (hoot-services Java classes).  Valid values are 'TikaLanguageDetector'
...
=== language.translation.hoot.services.translator.translator

* Data Type: string
* Default Value: `JoshuaLanguageTranslator`

Language translator used during to English language translation by HootServicesTranslator
(hoot-services Java class).  Valid values are 'joshua'.
...
* Data Type: string
* Default Value: `hoot::HootServicesTranslator`
