...
=== poi.implicit.tag.rules.custom.rule.list
...
'poi.implicit.tag.rules.rule.ignore.list'.
...
=== poi.implicit.tag.rules.tag.ignore.list
...
If true, the POI implicit tags will be derived/added using tokenized names.

=== poi.implicit.tag.rules.word.ignore.list
