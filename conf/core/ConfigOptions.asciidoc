...
* Data Type: string
* Default Value: `/home/vagrant/hoot/tmp/hoot-josm.jar`
...
=== map.cleaner.josm.add.debug.tags
...
=== map.cleaner.josm.add.validation.tags
...
=== map.cleaner.josm.validators.exclude
...
=== map.cleaner.josm.validators.include
...
=== map.cleaner.josm.java.implementation

* Data Type: string
* Default Value: `hoot/services/josm/JosmMapCleaner`

TODO

=== map.cleaner.josm.java.namespace

* Data Type: string
* Default Value: `org.openstreetmap.josm.data.validation.tests`
...
=== map.validator.josm.java.implementation
