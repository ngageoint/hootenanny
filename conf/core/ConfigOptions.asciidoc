...
=== apidb.reader.tag.immediately.connected.out.of.bounds.ways
...
crosses the bounds are tagged with a custom tag.

TODO: remove "apidb." from the front of this when implementing it for #3376
...
immediately connected to ways crossing or within the bounds.
