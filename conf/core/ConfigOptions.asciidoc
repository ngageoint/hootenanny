...
* Data Type: string
* Default Value: `hoot::ChangesetReplacementCreator1`

The `ChangesetReplacementCreator` implementation used for changeset replacement derivation when
only cutting data.

=== changeset.replacement.implementation

* Data Type: string
* Default Value: `hoot::ChangesetReplacementCreator7`
...
The map operations used by replacement changeset generation. TODO: not currently in use
...
List of tags to ignore when performing differential conflation with tags. Metadata tags are always
ignored.
