...
safety feature to ensure data integrity.  This will increase database writing performance.
The option 'osmapidb.bulk.writer.mode' must be set to 'offline' to enable this setting.  IMPORTANT:
Hootenanny does basic constraint checking for OSM data during load, but this should still only be
enabled when there is high confidence in the integrity of the data being written.
...
safety feature to ensure data integrity.  This will increase database writing performance.
The option 'osmapidb.bulk.writer.mode' must be set to 'offline' to enable this setting.  IMPORTANT:
This should only be enabled the database has previously been taken offline (you are the only
writer).
...
database writing performance.  The option 'osmapidb.bulk.writer.mode' must be set to 'offline' to
enable this setting.  IMPORTANT: This should only be enabled when the database has previously
been taken offline (you are the only writer).
