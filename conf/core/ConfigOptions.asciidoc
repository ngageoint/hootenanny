...
The OSM format to use for writing sorted temp files.  Valid values are 'osm' and 'pbf'.  PBF should
be a little more performant but currently loses some coordinate precision (need to fix).
