...
interacts with Hootenany and JOSM Java code via JNI. At a minimum this includes the JOSM jar managed
by `hoot-josm/pom.xml` (`josm.jar`) and the Hootenanny JOSM integration jar (`hoot-josm.jar`).
