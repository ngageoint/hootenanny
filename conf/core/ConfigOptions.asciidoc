...
If true, POI to Polygon conflation will only keep matches that are the closest to polygons and throw
out any others even if they score high enough for a match.  TODO: this option may go away
