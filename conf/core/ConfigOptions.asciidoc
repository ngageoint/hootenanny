...
The OSM format to use for writing sorted temp files.  Valid values are any extension Hootenanny can
both stream reading from and writing to (PartialMapReader/Writer implementation).
