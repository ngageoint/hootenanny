...
=== language.translation.service.host

* Data Type: string
* Default Value: `localhost`

Server hosting the language translation service

=== language.translation.service.port

* Data Type: int
* Default Value: `5674`

Port the server hosting the language translation service is listening on
...
ISO-639 language code for the source language of the to English translation
