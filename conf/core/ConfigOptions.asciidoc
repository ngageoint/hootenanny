...
=== conflate.match.unmatched.with.generic
...
** `hoot::ScriptMatchCreator,PointGeneric.js`
** `hoot::ScriptMatchCreator,LineStringGeneric.js`
** `hoot::ScriptMatchCreator,PolygonGeneric.js`
