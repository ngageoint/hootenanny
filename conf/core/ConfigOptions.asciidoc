...
=== apidb.changeset.maxwriters

* Data Type: long
* Default Value: `10`

The maximum number of writers to spawn for writing changesets in parallel to the OSM API database.

=== apidb.changeset.maxsize

* Data Type: long
* Default Value: `100`

Maximum number of changes per changeset when uploading to live OSM API
