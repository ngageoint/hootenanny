...
useful when debugging. The maps can be large and slow things down significantly. This setting is
independent of conflate.write.debug.maps.
...
Element criterion class which determines which feature are used for search radius calculation.
