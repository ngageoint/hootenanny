...
=== debug.maps.class.filter

* Data Type: string
* Default Value: ``

A semicolon delimited list of class names used for limiting the classes which write debug map
output. Do not prepend class names with their namespace. An empty string (default) disables the
filtering.
