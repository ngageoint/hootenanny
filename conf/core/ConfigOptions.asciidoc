...
=== attribute.conflation.update.building.outlines

* Data Type: bool
* Default Value: `false`

If true, building outlines get updated after conflation (complex buildings are merged). TODO: This
may go away completely, along with building.outline.update.op.remove.building.relations.
...
A list of tags not to be overwritten on target features during tag merging. Please keep
alphabetized.
