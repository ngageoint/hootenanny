...
=== generic.conflate.tag.threshold

* Data Type: double
* Default Value: `0.8`

Tag similarity threshold (0.0 to 1.0) at or above which an element is considered to have similar
tags when using generic geometry conflate matchers.
