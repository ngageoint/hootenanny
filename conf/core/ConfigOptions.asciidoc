...
Service endpoint for retrieving Hootenanny OAuth request tokens.
...
Service endpoint for logging out of Hootenanny.
...
Service endpoint for verifying Hootenanny logins.
...
Public access token of a Hootenanny Web Services authenticated user.  User authentication is
required by some commands and can be completed using the hoot 'login' command.
...
Private access token of a Hootenanny Web Services authenticated user.  User authentication is
required by some commands and can be completed using the hoot 'login' command.
...
Username of a Hootenanny Web Services authenticated user.  User authentication is
required by some commands and can be completed using the hoot 'login' command.
