...
VERY IMPORTANT NOTE: The changes apply to ALL elements and are applied AFTER the translation.
NOTE: This assumes that you know exactly what tags/attributes you want to modify/delete
