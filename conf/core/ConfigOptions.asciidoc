...
database being written to and has additional maintenance requirements.  Some osmapidb.* options
are only available in offline mode.  See the User Documentation for more details.
