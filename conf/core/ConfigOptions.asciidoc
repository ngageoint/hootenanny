...
When the OSM API database bulk inserter is writing directly to a database, if true, the inserter
drops the database constraints before writing the data and re-enables them after the writing is
complete.  This can only be used with databases that have been taken offline from other users.
...
When the OSM API database bulk inserter is writing directly to a database, if true, the inserter
drops the database indexes before writing the data and re-enables them after the writing is
complete.  This can only be used with databases that have been taken offline from other users.
