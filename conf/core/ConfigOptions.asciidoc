...
interacts with Hootenany and JOSM Java code via JNI. At a minimum this path includes the JOSM jar
managed by `hoot-josm/pom.xml` (`josm.jar`) and the Hootenanny JOSM integration jar
(`hoot-josm.jar`).
...
=== josm.validators.file

* Data Type: string
* Default Value: `${HOOT_HOME}/conf/core/validatorsJosm`

A path to a file containing a line delimited list of JOSM validator Java class names without
