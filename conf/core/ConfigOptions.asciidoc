...
=== language.translation.language.detector

* Data Type: string
* Default Value: `hoot::TikaLanguageDetector`

Language detector used by the ToEnglishTranslationVisitor
...
conf/core/language-translation/open-nlp.  This configuration option will likely be placed by a better
build process solution in the future.
...
conf/core/language-translation/open-nlp.
...
conf/core/language-translation/tika.  This configuration option will likely be placed by a better
build process solution in the future.
