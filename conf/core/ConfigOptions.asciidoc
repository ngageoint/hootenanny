...
=== differential.remove.partial.matches.as.whole
...
A list of type keys or key/value pairs eligible for moving from multilinestring relations to their
relation members when using `MultilineStringMergeRelationCollapser`.
