...
=== osm.changeset.sql.writer.generate.new.ids
...
=== postgresql.dumpfile.writer.output.buffer.max.line.size

* Data Type: long
* Default Value: `1000000`

Maximum number of lines to keep in memory when serializing the Postgresql Dumpfile Writer's output.
Each line roughly represents an element and each one of its tags.
