...
=== josm.certificate.path

* Data Type: string
* Default Value: ``

Some version of JOSM require a PKCS certificate to access certain functionality (.p12). Add the
path to your certificate file here.

=== josm.certificate.password

* Data Type: string
* Default Value: ``

Password for the certificate specified in josm.certificate.path.

=== josm.in.memory.map.size.max
