...
hoot::HootServicesLanguageDetectorClient.  Valid values are: 'low', 'medium', and 'high'.  Not all
server side language detectors specified in 'language.hoot.services.detectors' support detection
confidence.  When listing server side detectors via the API, confidence support information is
included.
