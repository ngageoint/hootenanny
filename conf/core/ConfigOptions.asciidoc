...
* Data Type: string
* Default Value: `http://localhost:8080/hoot-services/language/detectable`
...
* Data Type: string
* Default Value: `http://localhost:8080/hoot-services/language/detectors`
...
* Data Type: string
* Default Value: `http://localhost:8080/hoot-services/language/translatable`
...
* Data Type: string
* Default Value: `http://localhost:8080/hoot-services/language/translate`
...
* Data Type: string
* Default Value: `http://localhost:8080/hoot-services/language/translators`
