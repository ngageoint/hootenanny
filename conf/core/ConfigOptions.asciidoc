...
The direction that the translation script should translate. `toogr` will translate to OGR.
`toosm` will translate to OSM. This is used with the convert command, TranslationOp, or
TranslationVisitor.
