...
=== average.numeric.tags.visitor.keys

* Data Type: list
* Default Value:
** ``

List of tag keys for which the AverageNumericTagsVisitor averages numeric values.  Separate keys
with a ';' when passing in from the command line.
...
=== numeric.tags.visitor.keys

* Data Type: list
* Default Value:
** ``

List of tag keys for which the AverageNumericTagsVisitor or SumNumericTagsVisitor calculates
numeric values.  Separate keys with a ';' when passing in from the command line.
