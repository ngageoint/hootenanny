...
=== changeset.allow.deleting.reference.features.outside.bounds
...
=== convert.bounding.box.keep.immediate.connected.ways.outside.bounds
...
=== cookie.cutter.op.swap.inputs

* Data Type: bool
* Default Value: `false`

If false, elements with status=Unknown1 are cut out of the elements with status=Unknown2. If true,
the opposite occurs.
