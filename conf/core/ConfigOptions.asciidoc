...
If true, Hootenanny will attempt to translate any tag having a key in its schema or one that is
part of an address to English.  The configuration option, 'language.translation.translator',
controls which to English translator is used.
