...
# Project Goals
* Combine POIs and polygons for geolocational decision making
...
* Allow users to review and manually resolve features which cannot be automatically matched with sufficient certainty
