...
public:
  ...
  void partialTest1()
  {
    ...
    HOOT_STR_EQUALS("[1]{(s1: [1]{{ _start: { _e: (0) Node:-1 -- Way:-1 -- (1) Node:-9, _portion: 0 }, _end: { _e: (0) Node:-1 -- Way:-1 -- (1) Node:-9, _portion: 0.681189 } }} s2: [1]{{ _start: { _e: (2) Node:-10 -- Way:-2 -- (3) Node:-17, _portion: 0 }, _end: { _e: (2) Node:-10 -- Way:-2 -- (3) Node:-17, _portion: 1 } }}, 0.0144778)}",
      matchSet);
  }
  ...
  void partialTest2()
  {
    ...
    HOOT_STR_EQUALS("[1]{(s1: [1]{{ _start: { _e: (0) Node:-23 -- Way:-5 -- (1) Node:-24, _portion: 0 }, _end: { _e: (0) Node:-23 -- Way:-5 -- (1) Node:-24, _portion: 0.740262 } }} s2: [2]{{ _start: { _e: (4) Node:-18 -- Way:-3 -- (3) Node:-20, _portion: 0 }, _end: { _e: (4) Node:-18 -- Way:-3 -- (3) Node:-20, _portion: 1 } }, { _start: { _e: (2) Node:-21 -- Way:-4 -- (3) Node:-20, _portion: 1 }, _end: { _e: (2) Node:-21 -- Way:-4 -- (3) Node:-20, _portion: 0 } }}, 0.0781781)}",
      matchSet);
  }
  ...
  void partialTest3()
  {
    ...
    LOG_VAR(matchSet);
    HOOT_STR_EQUALS("[1]{(s1: [1]{{ _start: { _e: (0) Node:-25 -- Way:-6 -- (1) Node:-26, _portion: 0.274182 }, _end: { _e: (0) Node:-25 -- Way:-6 -- (1) Node:-26, _portion: 0.739918 } }} s2: [1]{{ _start: { _e: (2) Node:-27 -- Way:-7 -- (3) Node:-28, _portion: 0 }, _end: { _e: (2) Node:-27 -- Way:-7 -- (3) Node:-28, _portion: 1 } }}, 0.108977)}",
      matchSet);
  }
  ...
  void partialTest4()
  {
    ...
    LOG_VAR(matchSet);
    HOOT_STR_EQUALS("[1]{(s1: [3]{{ _start: { _e: (2) Node:-32 -- Way:-9 -- (0) Node:-31, _portion: 0.506102 }, _end: { _e: (2) Node:-32 -- Way:-9 -- (0) Node:-31, _portion: 1 } }, { _start: { _e: (0) Node:-31 -- Way:-12 -- (1) Node:-30, _portion: 0 }, _end: { _e: (0) Node:-31 -- Way:-12 -- (1) Node:-30, _portion: 1 } }, { _start: { _e: (3) Node:-29 -- Way:-8 -- (1) Node:-30, _portion: 1 }, _end: { _e: (3) Node:-29 -- Way:-8 -- (1) Node:-30, _portion: 0.502437 } }} s2: [2]{{ _start: { _e: (4) Node:-35 -- Way:-11 -- (5) Node:-34, _portion: 0 }, _end: { _e: (4) Node:-35 -- Way:-11 -- (5) Node:-34, _portion: 1 } }, { _start: { _e: (6) Node:-33 -- Way:-10 -- (5) Node:-34, _portion: 1 }, _end: { _e: (6) Node:-33 -- Way:-10 -- (5) Node:-34, _portion: 0 } }}, 0.0573093)}",
      matchSet);
  }
  ...
  void partialTest5()
  {
    ...
    LOG_VAR(matchSet);
    HOOT_STR_EQUALS("[1]{(s1: [1]{{ _start: { _e: (0) Node:-38 -- Way:-14 -- (1) Node:-39, _portion: 0.531175 }, _end: { _e: (0) Node:-38 -- Way:-14 -- (1) Node:-39, _portion: 1 } }} s2: [1]{{ _start: { _e: (2) Node:-36 -- Way:-13 -- (3) Node:-37, _portion: 0 }, _end: { _e: (2) Node:-36 -- Way:-13 -- (3) Node:-37, _portion: 1 } }}, 0.0437736)}",
      matchSet);
  }
