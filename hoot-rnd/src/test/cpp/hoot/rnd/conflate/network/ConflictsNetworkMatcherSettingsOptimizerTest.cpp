...
// Hoot
#include <hoot/rnd/conflate/network/ConflictsNetworkMatcherSettingsOptimizer.h>
#include <hoot/rnd/conflate/network/CaseTestFitnessFunction.h>
#include <hoot/rnd/conflate/network/RegressionReleaseTestFitnessFunction.h>
  ...
  void optimizeAgainstCaseDataTest()
  {
    boost::shared_ptr<AbstractTestFitnessFunction> fitnessFunction(
      new CaseTestFitnessFunction(
        "test-files/cases/hoot-rnd/network/conflicts",
        "test-files/cases/hoot-rnd/network/Config.conf"));
    ConflictsNetworkMatcherSettingsOptimizer().runOptimization(fitnessFunction, 100);
  }
  ...
  void optimizeAgainstRegressionReleaseDataTest()
  {
    boost::shared_ptr<AbstractTestFitnessFunction> fitnessFunction(
      new RegressionReleaseTestFitnessFunction(
        ...
        "test-files/cases/hoot-rnd/network/Config.conf"));
    ConflictsNetworkMatcherSettingsOptimizer().runOptimization(fitnessFunction, 10);
  }
