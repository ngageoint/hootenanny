...
hoot convert-osm2ogr -D api.db.email=test@test.com $HOOT_HOME/translations/RenderDb.js "$DB_URL/$MAP_ID" "PG:dbname='$RENDER_DB' host='$DB_HOST' port='$DB_PORT' user='$DB_USER' password='$DB_PASSWORD'"
