...
#echo "### 08. --without-cppunit --without-newmat --without-log4cxx --with-services" #failed
#./configure -q --without-cppunit --without-newmat --without-log4cxx --with-services                 && build_notest

#echo "### 09. --without-newmat --with-services" # failed
