  ...
  public static void init()
  {
    if (_initialized == false)
    {
      ...
      try
      {
        ...
        String hootHome = System.getenv("HOOT_HOME");
        if (hootHome != null && hootHome != "")
        {
          allLib.add(hootHome + "/lib");
        }
      ...
      catch (UnsatisfiedLinkError e)
      {
        ...
        System.out.flush();
        System.err
          .println("Error linking with HootSwig library. Is libHootSwig.so in your LD_LIBRARY_PATH?");
