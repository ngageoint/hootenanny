...
public:
  ...
  void runInsertTest()
  {
    ...
    shared_ptr<Relation> r1(new Relation(Status::Unknown1, 1, 15.0, MetadataTags::RelationCollection()));
  ...
  void runRemapInsertTest()
  {
    ...
    shared_ptr<Relation> r2(new Relation(Status::Unknown1, -2, 15.0, MetadataTags::RelationCollection()));
