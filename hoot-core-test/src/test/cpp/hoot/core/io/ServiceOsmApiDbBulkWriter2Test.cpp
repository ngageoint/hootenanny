...
// Hoot
#include <hoot/core/io/OsmApiDbBulkWriter2.h>
...
class ServiceOsmApiDbBulkWriter2Test : public CppUnit::TestFixture
{
  CPPUNIT_TEST_SUITE(ServiceOsmApiDbBulkWriter2Test);
  //TODO: finish
...
//  void verifyDatabaseOutputNoExternalWriters()
//  {
...
//  void verifyDatabaseOutputExternalWriters()
//  {
//    OsmApiDbReader reader;
//    OsmMapPtr map(new OsmMap());
//    reader.open(ServicesDbTestUtils::getOsmApiDbUrl().toString());
...
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(ServiceOsmApiDbBulkWriter2Test, "slow");
