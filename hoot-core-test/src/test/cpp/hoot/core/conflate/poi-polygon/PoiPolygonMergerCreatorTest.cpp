...
public:
  ...
  void basicTest()
  {
    ...
    PoiPolygonMatch match1(map, shared_ptr<MatchThreshold>(), shared_ptr<PoiPolygonRfClassifier>());
  ...
  void reviewTest()
  {
    ...
    PoiPolygonMatch match2(map, shared_ptr<MatchThreshold>(), shared_ptr<PoiPolygonRfClassifier>());
