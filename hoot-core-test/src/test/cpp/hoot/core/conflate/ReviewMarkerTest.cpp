...
public:
  ...
  void runSimpleTest()
  {
    ...
    HOOT_STR_EQUALS("{\"version\": 0.6,\"generator\": \"Hootenanny\",\"elements\": [\n"
      ...
      "{\"type\":\"node\",\"ref\":2,\"role\":\"reviewee\"}],\"tags\":{\"hoot:review:needs\":\"yes\",\"hoot:review:score\":\"-1\",\"hoot:review:note\":\"a note\",\"error:circular\":\"-1\"}]\n"
      "}\n",
  ...
  void runMultipleScoresTest()
  {
    ...
    HOOT_STR_EQUALS("{\"version\": 0.6,\"generator\": \"Hootenanny\",\"elements\": [\n"
      ...
      "{\"type\":\"node\",\"ref\":1,\"role\":\"reviewee\"},\n"
      "{\"type\":\"node\",\"ref\":2,\"role\":\"reviewee\"}],\"tags\":{\"hoot:review:needs\":\"yes\",\"hoot:review:score\":\"0.5\",\"hoot:review:note\":\"a note 2\",\"error:circular\":\"-1\"},\n"
      "{\"type\":\"relation\",\"id\":-1,\"members\":[\n"
      "{\"type\":\"node\",\"ref\":1,\"role\":\"reviewee\"},\n"
      "{\"type\":\"node\",\"ref\":2,\"role\":\"reviewee\"}],\"tags\":{\"hoot:review:needs\":\"yes\",\"hoot:review:score\":\"0.15\",\"hoot:review:note\":\"a note\",\"error:circular\":\"-1\"}]\n"
      "}\n",
      OsmJsonWriter().toString(map));
  }
