...
public:
  ...
  void funnyCurveTest()
  {
    ...
    long n1 = WayIdsVisitor::findWaysByTag(map, "note", "1")[0];
    long n2 = WayIdsVisitor::findWaysByTag(map, "note", "2")[0];
  ...
  void oneShortTest()
  {
    ...
    long n3 = WayIdsVisitor::findWaysByTag(map, "note", "3")[0];
    long n4 = WayIdsVisitor::findWaysByTag(map, "note", "4")[0];
