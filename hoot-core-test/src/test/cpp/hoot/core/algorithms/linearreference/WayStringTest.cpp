...
//    CPPUNIT_ASSERT(exThrown);
  ...
  void runCopySimplifiedWayTest()
  {
    ...
    HOOT_STR_EQUALS("way(-3)\n"
                    ...
                    "tags: name = w1\n"
                    "alt_name = w2\n"
                    "cached envelope: nan,nan,nan,nan\n"
                    "status: unknown1\n"
                    "version: 0\n"
                    "visible: 1\n"
                    "circular error: 1\n",
  ...
  void runPartialWayTest()
  {
    ...
    // length.
    HOOT_STR_EQUALS(70, ElementGeometryUtils::calculateLength(w1, map));
    HOOT_STR_EQUALS(40, ElementGeometryUtils::calculateLength(wayCopy, map));
