...
public:
  ...
  void basicTest()
  {
    ...
    v.visit(n);
    HOOT_STR_EQUALS("name = foo;bar;baz;bam bam\n"
                    "alt_name = bar\n"
                    "name:0 = the quick brown f...\n"
  ...
  void bigTest()
  {
    ...
    v.visit(n);
    HOOT_STR_EQUALS(QString::fromUtf8(
                    ...
                    "name:16 = Sint Vincent en de Grenadinen;St. Vincent an Grenadiinen;St. Vincent en de Grenadines;St. Vincent en die Grenadines;St. Vincent og Grenadinane;St. Vincent og Grenadinene;St. Vincent og Grenadinerne;St. Vincent un de Grenadinen\n"
