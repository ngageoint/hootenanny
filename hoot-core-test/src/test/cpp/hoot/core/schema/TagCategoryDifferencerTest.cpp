 ...
 *
 * @copyright Copyright (C) 2012, 2013, 2014, 2015, 2018, 2021, 2022 Maxar (http://www.maxar.com/)
 */
...
public:
  ...
  void compareRailwaysTest()
  {
    ...
    HOOT_STR_EQUALS(0.1, uut.diff(map, n1, n2));
    HOOT_STR_EQUALS(0.68, uut.diff(map, n1, n3));
    HOOT_STR_EQUALS(0.1, uut.diff(map, n1, n4));
  }
};

CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(TagCategoryDifferencerTest, "quick");
