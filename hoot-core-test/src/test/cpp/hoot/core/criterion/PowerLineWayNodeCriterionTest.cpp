...
class PowerLineWayNodeCriterionTest : public HootTestFixture
{
  CPPUNIT_TEST_SUITE(PowerLineWayNodeCriterionTest);
...
public:
  ...
  void runBasicTest()
  {
    ...
    PowerLineWayNodeCriterion uut(map);
...
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(PowerLineWayNodeCriterionTest, "quick");
