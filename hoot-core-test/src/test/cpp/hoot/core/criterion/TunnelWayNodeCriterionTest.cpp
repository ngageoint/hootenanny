...
#include <hoot/core/criterion/TunnelWayNodeCriterion.h>

namespace hoot
{

class TunnelWayNodeCriterionTest : public HootTestFixture
{
  CPPUNIT_TEST_SUITE(TunnelWayNodeCriterionTest);
...
public:
  ...
  void runBasicTest()
  {
    ...
    TunnelWayNodeCriterion uut(map);
...
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(TunnelWayNodeCriterionTest, "quick");
