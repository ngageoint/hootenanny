...
class NameContainsCriterionTest : public HootTestFixture
{
  CPPUNIT_TEST_SUITE(NameContainsCriterionTest);
...
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(NameContainsCriterionTest, "quick");
