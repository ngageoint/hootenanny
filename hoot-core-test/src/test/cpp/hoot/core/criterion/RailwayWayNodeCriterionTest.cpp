...
class RailwayWayNodeCriterionTest : public HootTestFixture
{
  CPPUNIT_TEST_SUITE(RailwayWayNodeCriterionTest);
...
public:
  ...
  void runBasicTest()
  {
    ...
    RailwayWayNodeCriterion uut(map);
...
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(RailwayWayNodeCriterionTest, "quick");
