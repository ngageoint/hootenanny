...
public:
  ...
  void unitsTest()
  {
    ...
    t1.set(MetadataTags::Length(), "60.0 mi");
    CPPUNIT_ASSERT_EQUAL(96560.6, QString::number(t1.getLength(MetadataTags::Length()).value(), 'g', 6).toDouble());

    t1.set(MetadataTags::Length(), "60mi");
    CPPUNIT_ASSERT_EQUAL(96560.6, QString::number(t1.getLength(MetadataTags::Length()).value(), 'g', 6).toDouble());
    ...
    t3.set(MetadataTags::Length(), "12'5\"");
    CPPUNIT_ASSERT_EQUAL(3.78, QString::number(t3.getLength(MetadataTags::Length()).value(), 'g', 3).toDouble());

    t4.set(MetadataTags::Length(), "10 nmi");
    CPPUNIT_ASSERT_EQUAL(18520.0, QString::number(t4.getLength(MetadataTags::Length()).value(), 'g', 6).toDouble());

    t5.set("maxspeed", "10 knots");
    CPPUNIT_ASSERT_EQUAL(5.14, QString::number(t5.getVelocity("maxspeed").value(), 'g', 3).toDouble());

    t6.set(MetadataTags::Length(), "10 km");
    CPPUNIT_ASSERT_EQUAL(10000.0, QString::number(t6.getLength(MetadataTags::Length()).value(), 'g', 6).toDouble());

    t7.set("maxspeed", "10 km/h");
    CPPUNIT_ASSERT_EQUAL(2.78, QString::number(t7.getVelocity("maxspeed").value(), 'g', 3).toDouble());

    t8.set(MetadataTags::Length(), "10 decimetres");
    CPPUNIT_ASSERT_EQUAL(1.0, QString::number(t8.getLength(MetadataTags::Length()).value(), 'g', 2).toDouble());
  }
