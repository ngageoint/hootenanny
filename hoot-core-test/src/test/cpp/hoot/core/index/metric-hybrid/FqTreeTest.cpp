 ...
 *
 * @copyright Copyright (C) 2013, 2015, 2016, 2017, 2018, 2019 Maxar (http://www.maxar.com/)
 */
...
public:
  ...
  void runRandomQueryTest()
  {
    ...
    set<QString> bag;
    UniqueTagValuesVisitor v1("name", bag, true);
    UniqueTagValuesVisitor v2("alt_name", bag, true);
    map->visitRo(v1);
    map->visitRo(v2);
