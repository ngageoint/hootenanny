...
public:
  ...
  void runRandomQueryTest()
  {
    ...
    {
      double x = Tgs::Random::instance()->s_generateDouble() * 100.0;
      double y = Tgs::Random::instance()->s_generateDouble() * 100.0;
    ...
    for (int depth = 0; depth <= 6; depth+=2)
    {
      ...
      {
        double x = Tgs::Random::instance()->s_generateDouble() * 300.0 - 150.0;
        double y = Tgs::Random::instance()->s_generateDouble() * 300.0 - 150.0;
        Coordinate c(x, y);
