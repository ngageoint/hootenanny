...
class NodeDensityCmd : public BaseCommand
{

  public:

    static string className() { return "hoot::NodeDensityCmd"; }

    NodeDensityCmd() { }

    virtual QString getName() const { return "node-density"; }
...
HOOT_FACTORY_REGISTER(Command, NodeDensityCmd)
