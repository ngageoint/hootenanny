...
class NameFrequenciesCmd : public BaseCommand
{
public:

  static string className() { return "hoot::NameFrequenciesCmd"; }
  ...
  virtual QString getName() const { return "name-frequencies"; }
...
HOOT_FACTORY_REGISTER(Command, NameFrequenciesCmd)
