...
class TagNameFrequenciesCmd : public BaseCommand
{
public:

  static string className() { return "hoot::TagNameFrequenciesCmd"; }
...
HOOT_FACTORY_REGISTER(Command, TagNameFrequenciesCmd)
