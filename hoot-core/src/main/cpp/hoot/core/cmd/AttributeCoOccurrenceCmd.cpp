...
class AttributeCoOccurrenceCmd : public BaseCommand
{
public:

  static string className() { return "hoot::AttributeCoOccurrenceCmd"; }

  AttributeCoOccurrenceCmd() { }
...
HOOT_FACTORY_REGISTER(Command, AttributeCoOccurrenceCmd)
