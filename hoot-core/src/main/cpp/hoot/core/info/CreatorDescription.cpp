...
CreatorDescription::CreatorDescription(const QString& className, const QString& description, bool experimental)
...
CreatorDescription::CreatorDescription(const QString& className, const QString& description, BaseFeatureType featureType, bool experimental)
  : _experimental(experimental),
    _className(className),
    _description(description),
...
std::shared_ptr<ElementCriterion> CreatorDescription::getElementCriterion(BaseFeatureType t, ConstOsmMapPtr map)
{
  switch (t)
  {
  case POI:
