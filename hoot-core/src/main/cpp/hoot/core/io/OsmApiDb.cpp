...
boost::shared_ptr<QSqlQuery> OsmApiDb::selectAllElements(const ElementType& elementType)
{
  switch (elementType.getEnum())
  {
    case ElementType::Node:
...
boost::shared_ptr<QSqlQuery> OsmApiDb::_getSelectNodesItr(const long minId)
{
  if (!_selectNodes)
  {
...
boost::shared_ptr<QSqlQuery> OsmApiDb::_getSelectWaysItr(const long minId)
{
  if (!_selectWays)
  {
...
boost::shared_ptr<QSqlQuery> OsmApiDb::_getSelectRelationsItr(const long minId)
{
  if (!_selectRelations)
  {
...
boost::shared_ptr<QSqlQuery> OsmApiDb::_getSelectAllNodesItr()
{
  if (!_selectAllNodes)
  {
...
boost::shared_ptr<QSqlQuery> OsmApiDb::_getSelectAllWaysItr()
{
  if (!_selectAllWays)
  {
...
boost::shared_ptr<QSqlQuery> OsmApiDb::_getSelectAllRelationsItr()
{
