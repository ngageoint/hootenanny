...
public:
  ...
  static void write(const std::shared_ptr<OsmMap>& map, const QString& url, const bool silent = false,
   ...
   */
  static void writeDebugMap(const std::shared_ptr<const OsmMap>& map, const QString& callingClass,
