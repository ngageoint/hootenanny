...
boost::shared_ptr<QSqlQuery> HootApiDb::selectAllElements(const ElementType& elementType)
{
  switch (elementType.getEnum())
  {
    case ElementType::Node:
...
boost::shared_ptr<QSqlQuery> HootApiDb::_getSelectNodesItr(const long minId)
{
  if (!_selectNodes)
  {
...
boost::shared_ptr<QSqlQuery> HootApiDb::_getSelectWaysItr(const long minId)
{
  if (!_selectWays)
  {
...
boost::shared_ptr<QSqlQuery> HootApiDb::_getSelectRelationsItr(const long minId)
{
  if (!_selectRelations)
  {
...
boost::shared_ptr<QSqlQuery> HootApiDb::_getSelectAllNodesItr()
{
  if (!_selectAllNodes)
  {
...
boost::shared_ptr<QSqlQuery> HootApiDb::_getSelectAllWaysItr()
{
  if (!_selectAllWays)
  {
...
boost::shared_ptr<QSqlQuery> HootApiDb::_getSelectAllRelationsItr()
{
