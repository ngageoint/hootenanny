...
void ShapefileWriter::_writeRelationPolygon(const ConstOsmMapPtr& map, const RelationPtr& relation,
...
void ShapefileWriter::_writeWayPolygon(const ConstOsmMapPtr& map, const WayPtr& way, OGRLayer* poLayer,
