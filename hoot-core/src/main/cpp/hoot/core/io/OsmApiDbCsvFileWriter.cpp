...
#include "OsmApiDbCsvFileWriter.h"
...
unsigned int OsmApiDbCsvFileWriter::logWarnCount = 0;

HOOT_FACTORY_REGISTER(OsmMapWriter, OsmApiDbCsvFileWriter)

OsmApiDbCsvFileWriter::OsmApiDbCsvFileWriter() :
_unflushedRecords(0)
{
...
bool OsmApiDbCsvFileWriter::isSupported(QString urlStr)
{
  return urlStr.toLower().endsWith(".csv");
}

void OsmApiDbCsvFileWriter::open(QString url)
{
  _init(url);
}

void OsmApiDbCsvFileWriter::_init(const QString outputUrl)
{
...
void OsmApiDbCsvFileWriter::close()
{
...
void OsmApiDbCsvFileWriter::finalizePartial()
{
...
void OsmApiDbCsvFileWriter::writePartial(const ConstNodePtr& node)
{
...
void OsmApiDbCsvFileWriter::writePartial(const ConstWayPtr& way)
{
...
void OsmApiDbCsvFileWriter::writePartial(const ConstRelationPtr& relation)
{
...
void OsmApiDbCsvFileWriter::_writeTags(ConstElementPtr element)
{
...
void OsmApiDbCsvFileWriter::setConfiguration(const hoot::Settings& conf)
{
