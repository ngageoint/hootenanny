 ...
 */
#ifndef CUSTOMPOIMERGECREATOR_H
#define CUSTOMPOIMERGECREATOR_H
...
namespace hoot
{
class CustomPoiMergerCreator : public MergerCreator
{
public:
  static string className() { return "hoot::CustomPoiMergerCreator"; }

  CustomPoiMergerCreator();
