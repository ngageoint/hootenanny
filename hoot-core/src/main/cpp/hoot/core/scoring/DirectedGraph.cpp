...
double DirectedGraph::determineCost(std::shared_ptr<Way> way)
{
...
void DirectedGraph::deriveEdges(std::shared_ptr<const OsmMap> map)
{
...
bool DirectedGraph::isOneWay(std::shared_ptr<Way> way)
{
