 ...
 */
#ifndef CHANGESET_REPLACEMENT_CREATOR_7_H
#define CHANGESET_REPLACEMENT_CREATOR_7_H
...
public:
  ...
  static std::string className() { return "hoot::ChangesetReplacementCreator7"; }

  ChangesetReplacementCreator7();
...
#endif // CHANGESET_REPLACEMENT_CREATOR_7_H
