...
#define RELATION_WITH_RIVER_MEMBERS_CRITERION_H
...
/**
 * Identifies relations having river members
 */
class RelationWithRiverMembersCriterion : public RelationWithMembersOfTypeCriterion
{
public:
...
#endif // RELATION_WITH_RIVER_MEMBERS_CRITERION_H
