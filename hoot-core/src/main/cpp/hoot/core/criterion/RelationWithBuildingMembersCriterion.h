...
#ifndef RELATION_WITH_BUILDING_MEMBERS_CRITERION_H
#define RELATION_WITH_BUILDING_MEMBERS_CRITERION_H
...
/**
 * Identifies relations having building members
 */
class RelationWithBuildingMembersCriterion : public RelationWithMembersOfTypeCriterion
{
public:
...
#endif // RELATION_WITH_BUILDING_MEMBERS_CRITERION_H
